...
ALTER TABLE `ibl_plr` MODIFY COLUMN `coach` tinyint unsigned DEFAULT '0' COMMENT 'FA pref: playoff performance weight (currently unused)';
...
ALTER TABLE `ibl_plr` MODIFY COLUMN `cy1` smallint DEFAULT '0' COMMENT 'Salary for contract year 1 (thousands, negative=cash from other team)';
ALTER TABLE `ibl_plr` MODIFY COLUMN `cy2` smallint DEFAULT '0' COMMENT 'Salary for contract year 2 (thousands, negative=cash from other team)';
ALTER TABLE `ibl_plr` MODIFY COLUMN `cy3` smallint DEFAULT '0' COMMENT 'Salary for contract year 3 (thousands, negative=cash from other team)';
ALTER TABLE `ibl_plr` MODIFY COLUMN `cy4` smallint DEFAULT '0' COMMENT 'Salary for contract year 4 (thousands, negative=cash from other team)';
ALTER TABLE `ibl_plr` MODIFY COLUMN `cy5` smallint DEFAULT '0' COMMENT 'Salary for contract year 5 (thousands, negative=cash from other team)';
ALTER TABLE `ibl_plr` MODIFY COLUMN `cy6` smallint DEFAULT '0' COMMENT 'Salary for contract year 6 (thousands, negative=cash from other team)';
...
ALTER TABLE `ibl_team_info` MODIFY COLUMN `Contract_Wins` int NOT NULL DEFAULT '0' COMMENT 'Wins from last season for FA Play for Winner weight';
