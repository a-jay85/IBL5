...
/**
 * PlayerDatabaseValidator - Validates and sanitizes player search parameters
 * 
 * Implements the validation contract defined in PlayerDatabaseValidatorInterface.
...
{
    /**
     * @see PlayerDatabaseValidatorInterface::validateSearchParams()
     */
    public function validateSearchParams(array $params): array
    {
        return [
            ...
            'r_3ga' => $this->validateIntegerParam($params['r_3ga'] ?? null),
            'r_3gp' => $this->validateIntegerParam($params['r_3gp'] ?? null),
    ...
    /**
     * @see PlayerDatabaseValidatorInterface::validateIntegerParam()
     */
    ...
    /**
     * @see PlayerDatabaseValidatorInterface::validateStringParam()
     */
    ...
    /**
     * @see PlayerDatabaseValidatorInterface::validateBooleanParam()
     */
