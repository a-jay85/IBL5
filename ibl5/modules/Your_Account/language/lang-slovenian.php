...
define("_NICK2LONG", "Nadimek je predolg. Biti mora manj�i od 25 znakov");
define("_NAMERESERVED", "NAPAKA: To ime je rezervirano");
define("_NICKNOSPACES", "NAPAKA: Nadimek ne sme vsebovati razmakov");
define("_NICKTAKEN", "NAPAKA: Nadimek je �e zaseden");
define("_EMAILREGISTERED", "NAPAKA: E-mail naslov je �e registriran");
define("_UUSERNAME", "Uporabni�ko ime");
define("_FINISH", "Kon�ano");
define("_YOUUSEDEMAIL", "Vi ali nekdo drugi je koristil Va� e-mail");
define("_TOREGISTER", "da registrira uporabni�ki ra�un na");
define("_FOLLOWINGMEM", "Informacije o �lanu:");
define("_UNICKNAME", "-Nadimek:");
define("_UPASSWORD", "-Geslo:");
define("_USERPASS4", "Uporabni�ko geslo za");
define("_YOUAREREGISTERED", "Sedaj ste registrirani. Najverjetneje ste �e prejeli geslo na e-mail, vne�ene pri registraciji.");
define("_THISISYOURPAGE", "To je va�a osebna stran");
...
define("_LAST10SUBMISSIONS", "Zadnjih 10 �lankov ki jih je poslal");
define("_LOGININCOR", "Napaka pri vstopu! Poizkusite ponovno...");
define("_USERLOGIN", "Vstop za �lane");
...
define("_COOKIEWARNING", "Opomba: Ra�uni so bazirani na cookijih (pi�kotkih).");
define("_ASREGUSER", "Kot �lan lahko:");
define("_ASREG1", "Po�iljate komentarje z lastnim imenom");
define("_ASREG2", "Po�iljate �lanke z lastnim imenom");
define("_ASREG3", "Imate oseben del na za�etni strani");
define("_ASREG4", "Izbirate koliko �lankov �elite na za�etni strani");
define("_ASREG5", "Spreminjate komentarje");
define("_ASREG6", "Izbirate razli�ite teme");
define("_ASREG7", "in �e nekatere druge stvari...");
define("_REGISTERNOW", "Registrirajte se! Brezpla�no je!");
define("_WEDONTGIVE", "Nikoli ne bomo prodali niti dali drugim osebam Va�ih osebnih informacij.");
...
define("_NOPROBLEM", "Ni problem. Samo vpi�ite nadimek in kliknite na po�lji. Poslali Vam bomo avtomatski E-mail z 'potrdilnim geslom'. Tedaj morate ponovno vpisati nadimek in potrdilno geslo, nakar boste prejeli novo geslo.");
define("_CONFIRMATIONCODE", "Potrdilno geslo");
define("_SENDPASSWORD", "Po�lji geslo");
define("_YOUARELOGGEDOUT", "Odjavljeni ste(logged out)!");
define("_SORRYNOUSERINFO", "�lan s tem nadimkom ni bil najden");
define("_USERACCOUNT", "Uporabni�ki ra�un");
define("_AT", "na");
define("_HASTHISEMAIL", "ima ta e-mail.");
define("_AWEBUSERFROM", "uporabnik iz");
define("_HASREQUESTED", "je pravkar dal zahtevo da se mu po�lje geslo.");
define("_YOURNEWPASSWORD", "Va�e novo geslo je:");
define("_YOUCANCHANGE", "Lahko spremenite po vstopu/prijavi na");
define("_IFYOUDIDNOTASK", "�e tega niste �eleli ne skrbite. Tega sporo�ila ne vidi nih�e razen Vas. �e je to napaka, samo lepo vstopite z novih geslom.");
...
define("_YOURCODEIS", "Va�e potrdilno geslo je:");
define("_WITHTHISCODE", "S tem geslom lahko izberete novo geslo na");
define("_IFYOUDIDNOTASK2", "�e tega niste �eleli ne skrbite. Enostavno izbri�ite e-mail sporo�ilo.");
define("_CODEFOR", "Potrdilno geslo za");
define("_USERPASSWORD4", "Uporabni�ko geslo za");
define("_UREALNAME", "Pravo ime");
define("_UREALEMAIL", "Pravi e-mail");
define("_EMAILNOTPUBLIC", "(To E-mail sporo�ilo ne bo javno, vendar je potrebno za po�iljanje gesla)");
define("_UFAKEMAIL", "La�ni/javni E-mail");
define("_EMAILPUBLIC", "(Ta E-mail bo javno objavljen. Napi�ite kar �elite)");
define("_YOURHOMEPAGE", "Va�a stran");
define("_YOURAVATAR", "Va� simbol");
define("_YICQ", "Va�a ICQ �tevilka");
define("_YAIM", "Va�a AIM �tevilka");
define("_YYIM", "Va�a YIM �tevilka");
define("_YMSNM", "Va�a MSNM �tevilka");
define("_YLOCATION", "Va�a lokacija");
define("_YOCCUPATION", "Va� poklic");
define("_YINTERESTS", "Va�i interesi");
define("_255CHARMAX", "(MAX 255 znakov. Podpis lahko vsebuje HTML oznake)");
define("_CANKNOWABOUT", "(MAX 255 znakov. Napi�ite kar �elite da drugi vedo o Vas)");
define("_TYPENEWPASSWORD", "(vnesite novo geslo dva krat za spremembo)");
define("_SOMETHINGWRONG", "Nekaj je zbrk***... sovra�e to toliko kot je?");
define("_PASSDIFFERENT", "Gesla sta razli�na. Morata biti enaka.");
define("_CHARLONG", "znakov");
define("_AVAILABLEAVATARS", "Popis dostopnih simbolov");
define("_NEWSINHOME", "�tevilo �lankov na za�etni strani");
define("_MAX127", "(max. 127):");
define("_ACTIVATEPERSONAL", "Aktiviraj osebno kazalo");
define("_CHECKTHISOPTION", "(Ozna�ite to opcijo in slede�i tekst se bo pojavil na za�etni strani)");
...
define("_THEMETEXT3", "Vsak uporabnik ima lahko svojo stran z temo po �elji.");
define("_DISPLAYMODE", "Prika�i mod");
define("_SORTORDER", "Vrstni red sortiranja");
define("_COMMENTSWILLIGNORED", "Komentarji z oceno manj�o od te postavke bodo ignorirani.");
define("_UNCUT", "Uncut and Raw");
define("_EVERYTHING", "Skoraj vse");
define("_FILTERMOSTANON", "Filtriraj ve�inoma anonimno");
define("_USCORE", "Ocena");
define("_SCORENOTE", "Anonimni za�enjajo z ocenom 0, �lani z 1. Moderatori dodajajo ali odvzemaju ocene.");
define("_NOSCORES", "Ne prikazuj ocene");
define("_HIDDESCORES", "(Skrite ocene: �e vedno so v veljavi, samo vidite jih ne.)");
define("_MAXCOMMENT", "Max dol�ina komentarja");
define("_TRUNCATES", "(Razstavljanje dolgih komentarjev in dodajanje Preberi ve� povezave. �e se temu �elite izogniti vpi�ite zares veliko �tevilko)");
define("_BYTESNOTE", "bytov (1024 bytov = 1K)");
define("_USENDPRIVATEMSG", "Po�lji privatno sporo�ilo �lanu");
...
define("_CHANGEHOME", "Spremeni za�etno stran");
define("_LOGOUTEXIT", "Izhod/Logout");
define("_SELECTTHETHEME", "Izberi temo");
define("_PRIVATEMESSAGES", "Va�a zasebna sporo�ila");
define("_EDITUSER", "Uredi uporabnika");
define("_RECEIVENEWSLETTER", "�elite prejemati PISMO z novicami po e-mailu?");
define("_NOTSUBSCRIBED", "Na na�e Pismo z novicami niste naro�eni");
define("_SUBSCRIBED", "Vi ste naro�nik na na�e Pismo z novicami");
