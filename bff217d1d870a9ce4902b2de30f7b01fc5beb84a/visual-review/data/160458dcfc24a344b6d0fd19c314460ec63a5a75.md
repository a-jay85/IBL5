...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> error-invalid-module
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=NonExistentModule", waiting until "load"
