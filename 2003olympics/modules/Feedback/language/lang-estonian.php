...
define("_FEEDBACKNOTE", "K�ik kommentarid ja ettepanekud selle veebilehe kohta on teretulnud, see on v��rtuslik informatsioon meile. T�nan!");
define("_FEEDBACKTITLE", "Tagaside v�ljad");
...
define("_FBENTERMESSAGE", "VIGA: Palun t�ida k�ik v�ljad!");
define("_SENDEREMAIL", "Saatja Email");
define("_SENDERNAME", "Saatja nimi");
define("_FBMAILSENT", "Mail on saatetud!");
define("_FBTHANKSFORCONTACT", "T�nan, et v�tsid meiega �hendust");
