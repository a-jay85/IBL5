...
define("_DSUBMITONCE", "Download po�ljite samo enkrat.");
...
define("_DOWNLOADSNOTUSER1", "Vi niste registriran �lan ali pa se niste prijavili.");
define("_DOWNLOADSNOTUSER2", "�e bi bili registrirani bi lahko dodajali downloade na to strani.");
define("_DOWNLOADSNOTUSER3", "Registriranje je hiter in enostaven proces.");
define("_DOWNLOADSNOTUSER4", "Zakaj zahtevamo registracijo za pristop dolo�enim stvarem?");
define("_DOWNLOADSNOTUSER5", "Zato, da Vam lahko ponudimo samo vsebino visoke kvalitete,");
define("_DOWNLOADSNOTUSER6", "vsako tako zasebno pregleduje in preverja na�e osebje.");
...
define("_DOWNLOADALREADYEXT", "NAPAKA: URL �e obstoja v bazi podatkov!");
...
define("_DOWNLOADRECEIVED", "Prejeli smo Va� predlog. Hvala!");
...
define("_DBESTRATED", "Downloadi z najbolj�imi ocenami - Top");
...
define("_DLETSDECIDE", "Komentarji uporabnikov kot ste Vi bodo pomagali drugim da se la�je odlo�ijo na kateri download naj kliknejo.");
define("_DRATENOTE4", "Lahko pogledate listo <a href=\"downloads.php?op=TopRated\">najbol�e ocenjenih downloadov</a>.");
define("_DATE", "Datum");
...
define("_POPULARITY1", "Popularnost (izpis povezav - od najmanj do najve� obiska)");
define("_POPULARITY2", "Popularnost (izpis povezav - od najve� do najmanj obiska)");
...
define("_ALLOWTORATE", "Omogo�ite ostalim obiskovalcem da ocenjujejo Va�o povezavo na Va�e strani!");
define("_TOTALOF", "Skupno od");
define("_USER", "uporabnik");
define("_USERAVGRATING", "Povpre�na ocena uporabnika");
...
define("_WEIGHNOTE", "* Opomba: Ocene registriranih uporabnikov imajo druga�no te�o od ocen neregistriranih uporabnikov");
define("_NOUNREGUSERSVOTES", "Ni ocen neregistriranih uporabnikov");
define("_WEIGHOUTNOTE", "* Opomba: Ocene registriranih uporabnikov imaju druga�no te�o od ocen zunajnih ocenjevalcev.");
...
define("_PROMOTE01", "Morda Vas interesira nekaj remote 'Oceni stran' opcij ki jih imamo. To Vam dopu��a postavljanje slik (ali celo obrazca za ocenjevanje) na Va�o stran z namenom ve�anja �tevila glasov. Izberite eno od spodaj navedenih opcij:");
define("_TEXTLINK", "Tekstualna povezava");
define("_PROMOTE02", "Eden od na�inov povezave na obrazec za ocenjevanje je preko obi�ajne tekstualne povezave:");
define("_HTMLCODE1", "V tom slu�aju uporabite slede�o HTML kodo:");
...
define("_PROMOTE03", "�e i��ete nekaj ve� od obi�jane tekstovne povezave, Vas morda zanima uporaba malega gumba za povezavo:");
...
define("_PROMOTE04", "�e boste pri tem varali bo Va�a povezava takoj izbrisana. Sedaj ko se razumemo, lahko pogledate kako trenutni remote obrazec izgleda.");
define("_VOTE4THISSITE", "Glasujte za to stran!");
define("_HTMLCODE3", "Preko tega obrazca je omogo�eno uporabnikom da ocenjujejo Va�o stran direktno iz nje. Zgornji obrazec je onemogo�en, vendar pa bo slede�a koda delovala �e jo postavite na va�o stran. Source koda je prikazana spodaj:");
define("_PROMOTE05", "Hvala! In sre�no z ocenami!");
define("_STAFF", "Osebje");
define("_THANKSBROKEN", "Hvala pri pomo�i v ohranjevanju integritete.");
define("_SECURITYBROKEN", "Iz sigurnostnih razlogov je Va�e uporabni�ko ime in IP naslov za�asno zabele�en.");
...
define("_RATENOTE1", "Prosim, da ne glasujete za isto stvar ve�krat.");
define("_RATENOTE2", "Razpon ocen je 1 - 10, 1 je najslab�e 10 najbolj�e.");
define("_RATENOTE3", "Prosim bodite objektivni pri ocenjevanju. �e bodo vsi imeli oceno 1 ali 10, potem od  ocen ne bo nobene koristi.");
define("_RATENOTE5", "Ne glasujte za lastno ali nasprotnikovo stran.");
define("_YOUAREREGGED", "Vi ste �lan in ste prijavljeni.");
define("_FEELFREE2ADD", "Svobodno dodajte komentar o ter strani.");
define("_YOUARENOTREGGED", "Vi niste �lan ali niste prijavljeni(login).");
define("_IFYOUWEREREG", "�e bi bili �lan bi lahko komentirali to stran.");
