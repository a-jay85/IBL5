...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> voting-results
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=VotingResults", waiting until "load"
