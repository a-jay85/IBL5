...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> standings-mobile
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=Standings", waiting until "load"
