...
define("_ADMPOLLS", "Unders�kelser/Avstemminger");
...
define("_ANNOUNCEPOLL", "Markedsf�r den nye avstemmingen p� siden");
define("_LEAVEBLANK", "(La v�re blank for � lage ny avstemming uten � markedsf�re den)");
