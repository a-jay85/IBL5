...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> player-database
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=PlayerDatabase", waiting until "load"
