-- Migration 076: Add full contract salary columns to vw_player_current
--
-- The view previously only exposed cy1 (year1_salary) and cy2 (year2_salary).
-- IBL contracts can be up to 6 years. Adding cy3-cy6 so the CSV player export
-- gives GMs full contract visibility in Google Sheets.
