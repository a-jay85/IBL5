...
interface FreeAgencyCapCalculatorInterface
{
     ...
     * 
     * The excludeOfferPid parameter allows accurate cap calculations when amending
     * an existing offer. Pass the player ID to exclude their current pending offer,
     ...
     *
     * @param int|null $excludeOfferPid Optional player ID to exclude from offer calculations
