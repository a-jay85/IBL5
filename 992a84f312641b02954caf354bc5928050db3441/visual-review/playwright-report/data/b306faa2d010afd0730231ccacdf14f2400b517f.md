...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 12470px, received 1280px by 12497px. 679992 pixels (ratio 0.05 of all image pixels) are different.
                ...
                - row [ref=f1e218]:
                  - cell [ref=f1e219]:
                    - link [ref=f1e220] [cursor=pointer]:
                      ...
                      - img "Test Player Two" [ref=f1e221]
                    - link "Test Player Two" [ref=f1e222] [cursor=pointer]:
                      - /url: modules.php?name=Player&pa=showpage&pid=2
                  - cell [ref=f1e223]:
                ...
                - row [ref=f1e232]:
                  - cell [ref=f1e233]:
                    - link [ref=f1e234] [cursor=pointer]:
                      - /url: modules.php?name=Player&pa=showpage&pid=5
                      - img "Stars Forward" [ref=f1e235]
                    - link "Stars Forward" [ref=f1e236] [cursor=pointer]:
                      - /url: modules.php?name=Player&pa=showpage&pid=5
                  - cell [ref=f1e237]:
