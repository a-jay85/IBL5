...
define("_TEAM", "Equipe.");
define("_EZTRANSFERLINKS", "Transf�rer tous les liens de la cat�gorie");
define("_EZTRANSFER", "Transf�rer");
define("_DELEZLINKCATWARNING", "Attention : Etes vous s�r de vouloir supprimer cette cat�gorie? Vous allez supprimer toutes les sous-cat�gories et tous ses liens attach�s !");
define("_EZTHEREIS", "Il y a");
define("_EZSUBCAT", "sous-cat�gories");
define("_EZATTACHEDTOCAT", "sous cette cat�gorie");
