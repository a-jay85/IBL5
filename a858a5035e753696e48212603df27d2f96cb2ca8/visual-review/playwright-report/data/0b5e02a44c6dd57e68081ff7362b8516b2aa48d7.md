...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 900px, received 1280px by 961px. 

  Snapshot: voting-eoy-playoffs.png

Call log:
  - Expect "toHaveScreenshot(voting-eoy-playoffs.png)" with timeout 10000ms
