...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> rookie-option
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=Player&pa=rookieoption&pid=200000032", waiting until "load"
