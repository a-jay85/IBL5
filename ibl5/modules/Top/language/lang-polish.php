...
define("_READSTORIES", "najcz�ciej czytanych artyku��w");
define("_COMMENTEDSTORIES", "najcz�ciej komentowanych artyku��w");
define("_ACTIVECAT", "najbardziej aktywnych kategorii");
define("_READSECTION", "najcz�ciej czytanych artyku��w w sekcji specjalnej");
