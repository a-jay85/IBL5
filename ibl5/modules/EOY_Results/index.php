...
$query15 = "select sum(score) as votes,name from (select MVP_1 as name, 1 as score from ibl_votes_EOY) as tbl group by name;";
$result15 = $db->sql_query($query15);
$num15 = $db->sql_numrows($result15);

$query2 = "select sum(score) as votes,name from (select Six_1 as name, 3 as score from ibl_votes_EOY union all select Six_2 as name, 2 as score from ibl_votes_EOY union all select Six_3 as name, 1 as score from ibl_votes_EOY) as tbl group by name;";
$result2 = $db->sql_query($query2);
$num2 = $db->sql_numrows($result2);

$query3 = "select sum(score) as votes,name from (select ROY_1 as name, 3 as score from ibl_votes_EOY union all select ROY_2 as name, 2 as score from ibl_votes_EOY union all select ROY_3 as name, 1 as score from ibl_votes_EOY) as tbl group by name;";
$result3 = $db->sql_query($query3);
$num3 = $db->sql_numrows($result3);

$query4 = "select sum(score) as votes,name from (select GM_1 as name, 3 as score from ibl_votes_EOY union all select GM_2 as name, 2 as score from ibl_votes_EOY union all select GM_3 as name, 1 as score from ibl_votes_EOY) as tbl group by name;";
