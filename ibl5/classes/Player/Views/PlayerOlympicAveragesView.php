...
/**
 * PlayerOlympicAveragesView - Renders Olympics averages
 * 
 * @see PlayerPageViewInterface
 */
class PlayerOlympicAveragesView implements PlayerPageViewInterface
{
    ...
    public function render(): string
    {
        ...
        $historicalStats = $this->statsRepository->getHistoricalStats($this->player->playerID, 'olympics');
...
<table border=1 cellspacing=0 style='margin: 0 auto;'>
    <tr>
        <td colspan=17 style='font-weight:bold; text-align:center; background-color:#060; color:#fff;'>Olympics Averages</td>
    </tr>
    <tr>
        <td colspan=17 style='text-align:center; padding: 10px;'>No Olympics statistics available.</td>
    </tr>
</table>
            <?php
            return ob_get_clean();
