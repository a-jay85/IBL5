...
/**
 * PlayerOlympicTotalsView - Renders Olympics totals
 * 
 * @see PlayerPageViewInterface
 */
class PlayerOlympicTotalsView implements PlayerPageViewInterface
{
...
<table border=1 cellspacing=0 style='margin: 0 auto;'>
    <tr>
        <td colspan=15 style='font-weight:bold; text-align:center; background-color:#060; color:#fff;'>Olympics Totals</td>
    </tr>
    <tr>
        <td colspan=15 style='text-align:center; padding: 10px;'>No Olympics statistics available.</td>
    </tr>
</table>
            <?php
            return ob_get_clean();
