...
/* http://phpnuke.org                                                   */
/*                                                                      */
/* postgres fix by Rub�n Campos - Oscar Silla                         */
/*                                                                      */
...
if (mb_eregi("sql_layer.php", $_SERVER['PHP_SELF'])) {
...
class ResultSet
{
    ...
    public function set_fetched_rows($rows)
    {
        $this->fetched_rows = $rows;
    }

    public function get_fetched_rows()
    {
        return $this->fetched_rows;
    }

    public function increment_fetched_rows()
    {
