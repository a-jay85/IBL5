...
define("_SHOW", "N�ita");
define("_BANNERSADMIN", "B�nnerid");
define("_ACTIVEBANNERS", "Praegu aktiivsed bannerid");
define("_ACTIVEBANNERS2", "Aktiivsed bannerid");
define("_IMPRESSIONS", "N�itamist");
define("_IMPLEFT", "N�itamist j�rel");
...
define("_PURCHASEDIMPRESSIONS", "Ostetud n�itamist");
...
define("_CLIENTPASSWD", "Kliendi salas�na");
...
define("_ADDIMPRESSIONS", "Lisa rohkem n�itamisi");
define("_DELETECLIENT", "Kustuta reklaamitav klient");
define("_SURETODELCLIENT", "Oled sa kindel, et soovid kustutada selle Klienti ja k�iki tema Bannereid!!!");
define("_CLIENTWITHOUTBANNERS", "Sellel Kliendil pole k�ivitatud �htegi Bannerit.");
define("_DELCLIENTHASBANNERS", "Sellel kliendil on j�rgnevad AKTIIVSED BANNERID k�ivitatud");
