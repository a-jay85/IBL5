...
define("_ASREGISTERED", "Er du ikke medlem enn�? Du kan enkelt <a href=\"modules.php?name=Your_Account\">bli medlem</a>. Som registrert medlem har du flere fordeler, og det er gratis � registrere seg!");
define("_MENUFOR", "Meny for");
define("_NOBIGSTORY", "Det finges ingen Het Nyhet i dag!");
define("_BIGSTORY", "Dagens mest leste nyhet er:");
define("_SURVEY", "Unders�kelse");
...
define("_YOUAREANON", "Du er en anonym bruker. Du kan registrere deg gratis ved � fylle ut <a href=\"modules.php?name=Your_Account\">dette skjemaet</a>");
define("_NOTE", "Noter:");
define("_ADMIN", "Admin:");
...
define("_MVIEWANON", "Se: Kun anonyme bes�kende");
define("_MVIEWALL", "Se: Alle bes�kende");
define("_EXPIRELESSHOUR", "Utl�per innen en time");
define("_EXPIREIN", "Utl�per om");
...
define("_SELECTGUILANG", "Velg spr�k for grensesnitt:");
define("_NONE", "Ingen");
...
define("_RESTRICTEDAREA", "Du pr�ver � f� adgang til et beskyttet omr�de.");
define("_MODULEUSERS", "Denne delen av v�re sider er kun for <i>registrerte brukere</i><br><br>Du kan registrere deg gratis <a href=\"modules.php?name=Your_Account&op=new_user\">her</a>.<br><br>");
define("_MODULESADMINS", "Beklager, men denne delen av v�re sider er kun for <i>administratorer</i><br><br>");
define("_HOME", "Hjem");
define("_HOMEPROBLEM", "Det er et stort problem: Vi har ingen f�rsteside!!");
define("_ADDAHOME", "Legg til en modul p� f�rstesiden");
define("_HOMEPROBLEMUSER", "Vi har et problem med sidene n�. Vennligst pr�v igjen senere.");
...
define("_BVIS", "Bes�kende");
define("_BMEM", "Medlemmer");
define("_BTT", "Totalt");
define("_BON", "Online n�");
...
define("_THISISAUTOMATED", "Dette er en automatisk e-post for � gi deg beskjed om at din banner-reklame p� v�r side er avsluttet n�.");
define("_THERESULTS", "Resultatene av kampanjen er som f�lger:");
...
define("_HOPEYOULIKED", "H�per du ble forn�yd med v�re tjenester. Vi ser frem til � f� deg som kunde igjen i fremtiden!");
define("_THANKSUPPORT", "Takk for din st�tte");
define("_TEAM", "Team");
define("_BANNERSFINNISHED", "Bannerannonser avsluttet");
define("_MODREQLINKS", "Mod. linker");
define("_BROKENLINKS", "�delagte linker");
define("_MODREQDOWN", "Mod. nedlastninger");
define("_BROKENDOWN", "�delagte nedlastninger");
