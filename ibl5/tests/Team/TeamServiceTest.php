 ...
 *
 * Validates data orchestration and starters extraction logic
 */
class TeamServiceTest extends TestCase
{
    ...
    // ============================================
    // getTeamPageData() - requires full app context (integration test)
    // Tested via manual verification against production output
    // ============================================
}
