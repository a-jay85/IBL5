 ...
 */
class DepthChartConfirmationTest extends TestCase
{
    private $processor;
    private $view;
    ...
    public function testAllThreeOutputsReceiveSameProcessedData()
    {
        ...
        // 1. DepthChartRepository::updatePlayerDepthChart() - for database
        // 2. DepthChartProcessor::generateCsvContent() - for CSV
        // 3. DepthChartView::renderSubmissionResult() - for confirmation page
