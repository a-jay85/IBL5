...
define("_LVOTES", "r�ster");
define("_HITS", "Tr�ffar");
define("_TOPWELCOME", "V�lkommen till TOPP sidan f�r");
define("_READSTORIES", "mest l�sta artiklar");
define("_COMMENTEDSTORIES", "mest kommenterade artiklar");
define("_ACTIVECAT", "mest aktiva kategorier");
define("_READSECTION", "mest l�sta artiklar i specialavdelningarna");
