...
<div class="top_menu">
  <ul>';
            ...
            $html .= '
    <li><a href="javascript:popup(\'http://iblhoops.net/modules.php?name=College_Scouting\', \'scouting\', 800, 400)">Draft Scouting</a></li>';
            if ($login->team_id()) {
                $html .= '
...
<p align="center"><a href="mock_draft_text.php" target="_blank">Text for forum (round 1)</a></p>';
        ...
        $col[] = "position.position_name";
        $list->set_header("position_name", "Pos");
        $col[] = "player.player_age";
        $list->set_header("player_age", "Age");
        ...
        $col[] = "selected_player.player_age selected_age";
        //$list->set_header("selected_age", "Age");
