 ...
 * @phpstan-type FreeAgencyOfferRow array{pid: int, teamid: int, team: string, name: string, offer1: int, offer2: int, offer3: int, offer4: int, offer5: int, offer6: int, ...<string, mixed>}
 */
