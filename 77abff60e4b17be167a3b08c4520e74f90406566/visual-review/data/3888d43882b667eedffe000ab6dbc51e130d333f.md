...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> one-on-one-game
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=OneOnOneGame", waiting until "load"
