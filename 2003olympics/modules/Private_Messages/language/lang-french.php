...
define("_BBLOGIN", "Connectez vous pour voir vos messages priv�s");
define("_BBPMSG", "Message priv�");
define("_BBINBOX", "dans la box");
define("_BBSELECTFORUM", "Choisir un Forum");
define("_BBNOFORUM", "Plus de Forums");
define("_BBBANNED", "Bannit");
define("_CLICKSMILEBUTTONS", "Cliquez sur les Smilies pour les ins�rer dans votre message:");
