...
define("_QUESTIONS", "K�simused ja vastused");
define("_ADDQUESTION", "Lisa uus k�simus");
define("_QUESTION", "K�simus");
define("_ANSWER", "Vastus");
define("_EDITCATEGORY", "Redigeeri kategooriat");
define("_EDITQUESTIONS", "Redigeeri k�simusi ja vastuseid");
define("_FAQDELWARNING", "HOIATUS: Oled sa kindel, et soovid kustutada KKK ja kogu selle sisu?");
define("_QUESTIONDEL", "HOIATUS: Oled sa kindel, et soovid kustutada selle k�simuse?");
