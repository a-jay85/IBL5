...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> projected-draft-order-mobile
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=ProjectedDraftOrder", waiting until "load"
