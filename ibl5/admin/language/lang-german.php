...
define("_FILEINCLUDE", "(W�hlen Sie einen spezifischen Block. Alle anderen Felder werden ignoriert.)");
...
define("_NLUNSUBSCRIBE", "=========================================================\nSie erhalten diesen Newsletter, weil Sie ihn in Ihrem Profil auf $sitename aktiviert haben.\nSie k�nnen dies sofort �ndern, indem Sie diese URL besuchen:\n\n$nukeurl/modules.php?name=Your_Account&op=edituser\"\n\nDann w�hlen Sie \"Nein\" aus den Optionen f�r den Newsletter per eMail aus und speicheren Ihre Einstellungen. Ben�tigen Sie mehr Hilfe, wenden Sie sich bitte an den $sitename Administrator.");
...
define("_MASSEMAILMSG", "=========================================================\nSie erhalten diese eMail, weil Sie auf $sitename registriert sind. Wir hoffen, dass Sie diese eMail nicht zu sehr st�rt und auf gewisse Weise dazu beitr�gt, unser Angebot zu verbessern.");
...
define("_NONUMVALUE", "Der Punktewert ist nicht nummerisch! Zur�ck gehen und &auml;ndern.");
...
define("_DESC04", "Punkte f�r jeden �ber das 'News-Submit-Modul' einsandten Artikel sowie anschliessende Ariteklfreigabe durch den Admin/Webredaktion");
define("_POINTS05", "News-Kommentar");
define("_DESC05", "Punkte f�r jeden geposteten Kommentar auf einen Arikel und/oder Newsbeitrag");
...
define("_DESC07", "Punkte f�r jede Bewertung eines Artikels");
define("_POINTS08", "Umfrage/n");
define("_DESC08", "F�r jede Stimme in einer Umfrage, egal ob neue oder alte Umfrage, erh&auml;lt der registrierte Benutzer, die eingetragene Punktzahl.");
define("_POINTS09", "Kommentar in Umfragen");
define("_DESC09", "Punkte f�r jeden geposteten Kommentar in einer Umfrage, egal ob alte oder neue Umfrage.");
define("_POINTS10", "Neuer Betrag im Forum");
define("_DESC10", "Punkte f�r jeden neu angelegten Beitrag im Forum.");
define("_POINTS11", "Antwort auf einen Forumbeitrag");
define("_DESC11", "Punkte f�r jede Antwort auf einen Forumbeitrag");
define("_POINTS12", "Testbericht Kommentar");
define("_DESC12", "Punkte f�r jeden geposteten Kommentar in den Testberichten/Reviews.");
define("_POINTS13", "Seitenaufruf");
define("_DESC13", "Der Benutzer erh�lt f�r jeden Seitenaufruf die eingetragene Punktzahl. Dies gilt f�r jede Seite dieses Portals!");
define("_POINTS14", "Weblink aufgerufen");
define("_DESC14", "Punkte f�r jeden Klick auf einen Eintrag in WebLinks und damit Aufruf der jeweiligen Homepage.");
define("_POINTS15", "Weblink-Bewertung");
define("_DESC15", "Punkte f�r jede Bewertung eines Linkeintrages im WebLink Modul.");
define("_POINTS16", "Weblink kommentiert");
define("_DESC16", "Punkte f�r jeden geposteten Kommentar auf einen Linkeintrag im WebLink Modul.");
define("_POINTS17", "Broadcast Nachricht");
define("_DESC17", "Punkte f�r jede &ouml;ffentliche Nachricht unter Nutzung des Broadcast-Nachrichtensystem");
define("_POINTS18", "Klick auf irgendeinen Banner");
define("_DESC18", "Der Weg dem Benutzer etwas zur�ckzugeben - Punkte f�r jeden Klick auf einen Werbebanner dieser Seite.");
