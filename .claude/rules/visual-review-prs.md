...
per-SHA gallery dirs by a 14-day age gate (keyed on newest commit date), then caps the tree at the 300 most recent dirs. Its `gh-pages` push carries the same
