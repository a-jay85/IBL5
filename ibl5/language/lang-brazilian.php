...
define("_ASREGISTERED", "Ainda n�o � Cadastrado? Voc� pode se cadastrar clicando <a href=\"modules.php?name=Your_Account&amp;op=new_user\">aqui</a>. Como usu�rio cadastrado voc� tem algumas vantagens como escolher o Tema do site (template) e enviar coment�rios com seu nome.");
...
define("_YOUAREANON", "Voc� � um usu�rio an�nimo. Voc� pode se cadastrar gratuitamente clicando <a href=\"modules.php?name=Your_Account&amp;op=new_user\">aqui</a>.");
define("_NOTE", "Nota:");
define("_ADMIN", "Admin:");
...
define("_MODULEUSERS", "Sentimos muito mas esa parte do nosso conte�do � somente para <b>usu�rios cadastrados</b>.<br><br>Voc� pode se cadastrar gratuitamente clicando <a href=\"modules.php?name=Your_Account&op=new_user\">aqui</a>, e ent�o voc� ter� accesso<br>a esta e outras se��es do nosso conte�do sem resri��es.<br><br>");
...
define("_HOMEPROBLEMUSER", "H� um problema com este portal no momento. Por avor, retorne detnro de alguns instantes.");
