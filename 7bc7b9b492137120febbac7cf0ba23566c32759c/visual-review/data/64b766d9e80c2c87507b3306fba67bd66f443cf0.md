...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> waivers-empty-mobile
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=Waivers", waiting until "load"
...
- generic [active] [ref=e1]:
  - navigation [ref=e2]:
    - link "Switch to localhost" [ref=e5] [cursor=pointer]:
      - /url: http://localhost/ibl5/modules.php?name=Waivers
      - img [ref=e6]
    - generic [ref=e10]:
  ...
  - main [ref=e26]:
    ...
    - generic [ref=e28]:
      - heading "Waivers" [level=1] [ref=e29]
      - paragraph [ref=e30]: Sorry, but players may not be added from or dropped to waivers at the present time.
```
