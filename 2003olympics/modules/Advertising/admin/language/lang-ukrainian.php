...
define("_CLIENTNAME", "��'� �볺���");
define("_ADVERTISINGCLIENTS", "������� �볺���");
define("_CONTACTNAME", "��'�");
...
define("_ADDBANNER", "������ ������");
define("_ADDCLIENT", "������ ������ �볺���");
define("_CLIENTLOGIN", "���� �볺���");
define("_CLIENTPASSWD", "������ �볺���");
define("_ADDCLIENT2", "������ �볺���");
define("_DELETEBANNER", "������� �����");
define("_SURETODELBANNER", "�� ����� ������ ������� �����?");
define("_EDITBANNER", "���������� �����");
define("_ADDIMPRESSIONS", "�������� ������");
define("_DELETECLIENT", "������� �볺���");
define("_SURETODELCLIENT", "�� ��������� ������� �볺��� � �� ���� ������!!!");
define("_CLIENTWITHOUTBANNERS", "� ����� �볺��� ���� �������� ������.");
define("_DELCLIENTHASBANNERS", "� ����� �볺��� � �������� ������� ������");
define("_EDITCLIENT", "���������� �볺���");
define("_POSITION", "�������");
define("_ACTIVE", "��������");
define("_DEACTIVATE", "������� ����������");
define("_INACTIVE", "����������");
