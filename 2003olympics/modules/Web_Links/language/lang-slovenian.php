...
define("_ONLYREGUSERSMODIFY", "Samo �lani lahko predlagajo spremembe downloada. Prosim <a href=\"modules.php?name=Your_Account\">registrirajte se ali pa se prijavite</a>.");
define("_DATE", "Datum");
...
define("_LINKSNOTUSER1", "Niste �lan, ali pa se niste prijavili(login).");
define("_LINKSNOTUSER2", "Samo �lani lahko dodajajo povezave na to stran.");
define("_LINKSNOTUSER3", "Registriranje je hiter in enostaven proces.");
define("_LINKSNOTUSER4", "Zakaj zahtevamo registracijo za pristop dolo�enim stvarem?");
...
define("_LINKSNOTUSER7", "Zato, ker Vam �elimo Vam ponuditi samo to�ne in prave informacije.");
...
define("_VISITTHISSITE", "Obi��ite to stran");
...
define("_LETSDECIDE", "Komentarji in ocene uporabnika kakor Vi bo pomagalo ostalim uporabnikom pri odlo�itvi na katere povezave naj kliknejo.");
