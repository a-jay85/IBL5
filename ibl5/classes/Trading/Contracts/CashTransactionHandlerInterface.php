...
interface CashTransactionHandlerInterface
{
     ...
     *
     * Generates human-readable trade text for cash transactions,
     * with each non-zero year on its own line with a season label.
     *
     ...
     *  - Names formatted as "| Cash to {team}" and "| Cash from {team}"
