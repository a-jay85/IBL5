...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> voting-eoy-playoffs-mobile
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 871px, received 375px by 973px. 

  Snapshot: voting-eoy-playoffs-mobile.png

Call log:
  - Expect "toHaveScreenshot(voting-eoy-playoffs-mobile.png)" with timeout 10000ms
...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e26]:
    - heading "End-of-Year Awards Ballot" [level=1] [ref=f1e27]
    - generic [ref=f1e29]:
      - button "Submit Votes!" [ref=f1e30] [cursor=pointer]
      - generic [ref=f1e31] [cursor=pointer]:
        - heading "Most Valuable Player" [level=2] [ref=f1e32]
        - paragraph [ref=f1e33]: Select your top THREE choices. Tap/click to reveal/hide nominees.
      - generic [ref=f1e34] [cursor=pointer]:
        - heading "Sixth-Person of the Year" [level=2] [ref=f1e35]
        - paragraph [ref=f1e36]: Select your top THREE choices. Tap/click to reveal/hide nominees.
      - generic [ref=f1e37] [cursor=pointer]:
        - heading "Rookie of the Year" [level=2] [ref=f1e38]
        - paragraph [ref=f1e39]: Select your top THREE choices. Tap/click to reveal/hide nominees.
      - generic [ref=f1e40] [cursor=pointer]:
        - heading "General Manager of the Year" [level=2] [ref=f1e41]
        - paragraph [ref=f1e42]: Select your top THREE choices. Tap/click to reveal/hide nominees.
      - button "Submit Votes!" [ref=f1e43] [cursor=pointer]
    - generic [ref=f1e44] [cursor=pointer]:
      - heading "Voting Results" [level=2] [ref=f1e45]
      - paragraph [ref=f1e46]: Tap/click to reveal/hide results.
```
