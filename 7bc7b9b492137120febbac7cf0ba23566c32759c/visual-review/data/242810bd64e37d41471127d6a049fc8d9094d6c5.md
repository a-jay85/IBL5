...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> franchise-record-book
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=FranchiseRecordBook&teamid=1", waiting until "load"
