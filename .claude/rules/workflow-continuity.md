...
When executing the post-plan-approval workflow (Phases 1-7), skill completions are NOT stopping points. After ANY skill invocation returns output, IMMEDIATELY proceed to the next phase in the same response.
