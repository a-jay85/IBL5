...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> voting-eoy-draft
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: voting-eoy-draft.png

Call log:
  - Expect "toHaveScreenshot(voting-eoy-draft.png)" with timeout 10000ms
