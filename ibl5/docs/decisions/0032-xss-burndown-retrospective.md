---
description: Retrospective ADR documenting the complete XSS burndown across Plans A, B, and C — 315 baseline suppressions eliminated, 18 view files now in zero-floor.
