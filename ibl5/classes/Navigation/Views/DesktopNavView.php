...
class DesktopNavView
{
    ...
    public function render(array $menus, ?array $myTeamMenu, array $accountMenu): string
    {
        ...
        ?>
                    ...
                    <div class="nav-desktop">
                        ...
                        <button id="mobile-view-toggle" class="hidden nav-icon-btn ml-1" aria-label="Switch to mobile view" title="Switch to mobile view">
    ...
    private function renderDropdown(string $title, array $data, bool $includeLoginForm = false, bool $includeLeagueSwitcher = false, bool $alignRight = false, bool $includeLogoutFooter = false): string
    {
        ...
        $cardModifier = $includeLoginForm ? 'nav-dropdown__card--wide' : 'nav-dropdown__card--narrow';
        $dropdownModifier = $alignRight ? 'nav-dropdown--right' : 'nav-dropdown--left';
