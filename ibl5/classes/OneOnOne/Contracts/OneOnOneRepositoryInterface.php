...
/**
 * OneOnOneRepositoryInterface - Contract for One-on-One game data access
 * 
 ...
 */
interface OneOnOneRepositoryInterface
{
    /**
     ...
     * @return array<string, mixed>|null Player data array or null if not found
     */
     ...
     * @return array<string, mixed>|null Game data array or null if not found
     */
