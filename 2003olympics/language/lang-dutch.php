...
define("_PRIVATEMSG", "priv�-bericht(en).");
...
define("_EXPIRELESSHOUR", "Vervalt binnen ��n uur");
...
define("_ALLCATEGORIES", "Alle categorie�n");
...
define("_THISISAUTOMATED", "Dit is een automatisch E-mail om u te laten weten dat uw banner advertering in uw site nu be�indigd is.");
...
define("_TEAM", "Team");
define("_BANNERSFINNISHED", "Banners Toevoegingen Be�indigd");
