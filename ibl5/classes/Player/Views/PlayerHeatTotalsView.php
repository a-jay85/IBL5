...
/**
 * PlayerHeatTotalsView - Renders Heat (IBL tournament) totals
 * 
 * @see PlayerPageViewInterface
 */
class PlayerHeatTotalsView implements PlayerPageViewInterface
{
...
<table border=1 cellspacing=0 style='margin: 0 auto;'>
    <tr>
        <td colspan=15 style='font-weight:bold; text-align:center; background-color:#f60; color:#fff;'>Heat Tournament Totals</td>
    </tr>
    <tr>
        <td colspan=15 style='text-align:center; padding: 10px;'>No Heat tournament statistics available.</td>
    </tr>
</table>
            <?php
            return ob_get_clean();
