...
J23 round-half-up + base_time re-center (✅, 2026-07-16, #1495) — coupled faithful fix deferred from J21; ADR-0085 records the hold finding; shipped round-half-up + baseTimeMid re-center 14.5→13.65 (J23)
  └─→ J24 possession-clock subsystem port (◑ Partial 2026-07-18) — step classes + jitter SHIPPED; steal split + faithful shotValue2pt/3pt (D80/D60/D64/DE8, blockMod, flow term wired) SHIPPED (j24-mix-fixes PR); FG% 46.08% (flow term near-zero with matchupQuality Phases 3/4 stubs; closes when PR4/coaching lands); residuals: matchupQuality Phase 3/4, CEngine+0x30 flag, .lge +0x12c strategy_adj, baseTimeMid walkback to 16.0
