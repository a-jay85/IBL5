...
/**
 * PlayerHeatAveragesView - Renders Heat (IBL tournament) averages
 * 
 * @see PlayerPageViewInterface
 */
class PlayerHeatAveragesView implements PlayerPageViewInterface
{
    ...
    public function render(): string
    {
        ...
        $historicalStats = $this->statsRepository->getHistoricalStats($this->player->playerID, 'heat');
...
<table border=1 cellspacing=0 style='margin: 0 auto;'>
    <tr>
        <td colspan=17 style='font-weight:bold; text-align:center; background-color:#f60; color:#fff;'>Heat Tournament Averages</td>
    </tr>
    <tr>
        <td colspan=17 style='text-align:center; padding: 10px;'>No Heat tournament statistics available.</td>
    </tr>
</table>
            <?php
            return ob_get_clean();
