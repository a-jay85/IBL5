...
| L74 | PR body `## Manual Testing` rotting step-ordinal + false coverage-type claim contradicts diff | ✅ fixed this pass | 🟦 | XS |
| L75 | Three Phase 6 review notes from PR #1801: plan supersession (F3), undeclared scope (F4), stale comment (F5) | ✅ fixed this pass | 🟦 | XS |
| L76 | Phase 6 notes from PR #1801 (second /pr-ready pass): missing Changes bullet (F4, fixed), carry-forward notes F1/F2/F5 | ✅ fixed this pass | 🟦 | XS |
...
### L74 PR body `## Manual Testing` rotting step-ordinal + false coverage-type claim contradicts diff
...
### L75 Three Phase 6 review notes from PR #1801: plan supersession (F3), undeclared scope (F4), stale comment (F5)
...
### L76 Phase 6 notes from PR #1801 (second /pr-ready pass): missing Changes bullet (F4, fixed), carry-forward notes F1/F2/F5
...
| 5 | Prior pass — L75 F4: same class (undeclared scope in PR body) | yes | yes | not fixed — filed in L75 |
