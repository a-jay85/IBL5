 ...
 * Search Section
 * 
 * slug: basketball-club/search
 * title: Search
 * categories: basketball-club
 */

return array(
    'title'      =>__( 'Search', 'basketball-club' ),
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"basketball-club","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
);