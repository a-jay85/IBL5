    ...
    private function renderLoginForm(): string
    {
        ...
        <div class="px-4 pt-4 pb-3">
            <form action="modules.php?name=YourAccount" method="post" class="space-y-3">
                ...
                <!-- Remember me -->
                <label class="flex items-center gap-2.5 cursor-pointer group/remember py-0.5">
                    <span class="relative inline-flex items-center justify-center w-4 h-4 shrink-0">
                        <input
                            type="checkbox"
                            name="remember_me"
                            value="1"
                            class="peer appearance-none w-4 h-4 rounded border border-white/20 bg-white/5 checked:bg-accent-500 checked:border-accent-500 focus-visible:ring-2 focus-visible:ring-accent-500/50 group-hover/remember:border-white/30 transition-all duration-150 cursor-pointer"
                        >
                        <svg class="absolute w-2.5 h-2.5 text-white pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity duration-150" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </span>
                    <span class="text-sm text-gray-400 group-hover/remember:text-gray-300 transition-colors duration-150 select-none">Remember me</span>
                </label>
    ...
    private function renderMobileLoginForm(): string
    {
        ...
        <div class="px-5 pt-4 pb-4 bg-gradient-to-b from-accent-500/10 to-transparent">
            <form action="modules.php?name=YourAccount" method="post" class="space-y-3">
                ...
                <!-- Remember me -->
                <label class="flex items-center gap-3 cursor-pointer group/remember py-0.5">
                    <span class="relative inline-flex items-center justify-center w-5 h-5 shrink-0">
                        <input
                            type="checkbox"
                            name="remember_me"
                            value="1"
                            class="peer appearance-none w-5 h-5 rounded-md border border-white/20 bg-white/5 checked:bg-accent-500 checked:border-accent-500 focus-visible:ring-2 focus-visible:ring-accent-500/50 group-hover/remember:border-white/30 transition-all duration-150 cursor-pointer"
                        >
                        <svg class="absolute w-3 h-3 text-white pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity duration-150" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </span>
                    <span class="text-base text-gray-400 group-hover/remember:text-gray-300 transition-colors duration-150 select-none">Remember me</span>
                </label>
