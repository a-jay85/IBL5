...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: api-keys-guide.png

Call log:
  - Expect "toHaveScreenshot(api-keys-guide.png)" with timeout 10000ms
  ...
  - main [ref=f1e70]:
    ...
    - generic [ref=f1e80]:
      ...
      - generic [ref=f1e83]:
        ...
        - generic [ref=f1e93]:
          - strong [ref=f1e94]: Your key is part of this URL.
          ...
          - code [ref=f1e95]: X-API-Key
          - text: header instead. If the URL gets shared, revoke the key and generate a new one.
        - heading "Column Reference" [level=3] [ref=f1e96]
        - table [ref=f1e97]:
          - rowgroup [ref=f1e98]:
            - row [ref=f1e99]:
              - columnheader "Column" [ref=f1e100]
              - columnheader "Description" [ref=f1e101]
          - rowgroup [ref=f1e102]:
            - row [ref=f1e103]:
              - cell "PID" [ref=f1e104]
              - cell "Player ID" [ref=f1e105]
            - row [ref=f1e106]:
              - cell "Name" [ref=f1e107]
              - cell "Player name" [ref=f1e108]
            - row [ref=f1e109]:
              - cell "Nickname" [ref=f1e110]
              - cell "Player nickname" [ref=f1e111]
            - row [ref=f1e112]:
              - cell "Age" [ref=f1e113]
              - cell "Player age" [ref=f1e114]
            - row [ref=f1e115]:
              - cell "Position" [ref=f1e116]
              - cell "PG, SG, SF, PF, or C" [ref=f1e117]
            - row [ref=f1e118]:
              - cell "Height (ft) / Height (in)" [ref=f1e119]
              - cell "Height in feet and inches" [ref=f1e120]
            - row [ref=f1e121]:
              - cell "Active" [ref=f1e122]
              - cell "1 = on a depth chart, 0 = not" [ref=f1e123]
            - row [ref=f1e124]:
              - cell "Retired" [ref=f1e125]
              - cell "1 = retired, 0 = active" [ref=f1e126]
            - row [ref=f1e127]:
              - cell "Experience" [ref=f1e128]
              - cell "Years of experience" [ref=f1e129]
            - row [ref=f1e130]:
              - cell "Bird Rights" [ref=f1e131]
              - cell "Bird rights status" [ref=f1e132]
            - row [ref=f1e133]:
              - cell "Team ID / Team City / Team Name" [ref=f1e134]
              - cell "Team information (empty for free agents)" [ref=f1e135]
            - row [ref=f1e136]:
              - cell "Owner" [ref=f1e137]
              - cell "Team owner username" [ref=f1e138]
            - row [ref=f1e139]:
              - cell "Contract Year" [ref=f1e140]
              - cell "Current year of contract (1-6, 0 = unsigned)" [ref=f1e141]
            - row [ref=f1e142]:
              - cell "Current Salary" [ref=f1e143]
              - cell "Salary for the current contract year (thousands)" [ref=f1e144]
            - row [ref=f1e145]:
              - cell "Year 1-6 Salary" [ref=f1e146]
              - cell "Full contract breakdown by year (thousands)" [ref=f1e147]
            - row [ref=f1e148]:
              - cell "GP / MIN" [ref=f1e149]
              - cell "Games played / minutes played (season totals)" [ref=f1e150]
            - row [ref=f1e151]:
              - cell "FGM / FGA" [ref=f1e152]
              - cell "Field goals made / attempted (season totals)" [ref=f1e153]
            - row [ref=f1e154]:
              - cell "FTM / FTA" [ref=f1e155]
              - cell "Free throws made / attempted (season totals)" [ref=f1e156]
            - row [ref=f1e157]:
              - cell "3PM / 3PA" [ref=f1e158]
              - cell "Three-pointers made / attempted (season totals)" [ref=f1e159]
            - row [ref=f1e160]:
              - cell "ORB / DRB" [ref=f1e161]
              - cell "Offensive / defensive rebounds (season totals)" [ref=f1e162]
            - row [ref=f1e163]:
              - cell "AST / STL / TO / BLK / PF" [ref=f1e164]
              - cell "Assists, steals, turnovers, blocks, personal fouls (season totals)" [ref=f1e165]
            - row [ref=f1e166]:
              - cell "PPG" [ref=f1e167]
              - cell "Points per game" [ref=f1e168]
            - row [ref=f1e169]:
              - cell "FG% / FT% / 3P%" [ref=f1e170]
              - cell "Shooting percentages" [ref=f1e171]
        - heading "Tips" [level=3] [ref=f1e172]
        - list [ref=f1e173]:
          - listitem [ref=f1e174]: Data refreshes each time Google Sheets recalculates (approximately every hour).
          - listitem [ref=f1e175]: Use Google Sheets' built-in FILTER, SORT, and QUERY functions to slice the data.
          - listitem [ref=f1e176]: Salary values are in thousands (e.g., 1500 = $1,500K).
          - listitem [ref=f1e177]: Stats columns (GP, MIN, FGM, etc.) are season totals. Divide by GP for per-game averages.
        - heading "Key Management" [level=3] [ref=f1e178]
        - paragraph [ref=f1e179]: Visit API Key Management to view, revoke, or regenerate your key. Each user can have one active key at a time.
```
