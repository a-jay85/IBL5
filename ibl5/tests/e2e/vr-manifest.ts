...
export const VR_MANIFEST: VrRow[] = [
  ...
  { name: 'all-star-appearances', auth: 'public', url: 'modules.php?name=RecordHolders&op=allstar',
  ...
  { name: 'career-leaderboards', auth: 'public', url: 'modules.php?name=Leaderboards&tab=career',
  ...
  { name: 'injuries', auth: 'public', url: 'modules.php?name=Injuries',
    anchor: '.ibl-data-table', viewports: ['desktop', 'mobile'] },
  { name: 'last-sim-recap', auth: 'auth', url: 'modules.php?name=News',
    anchor: '.last-sim-recap', viewports: ['desktop', 'mobile'],
    skipContentCheck: true,
    notes: 'Recap card renders within the News module for authenticated GMs (not a standalone module). LastSimRecap is a News sub-component; anonymous News visitors do not see the card.' },
  ...
  { name: 'news-categories', auth: 'public',
    url: 'modules.php?name=News&file=categories&op=newindex&catid=15',
    anchor: '.ibl-title', viewports: ['desktop', 'mobile'] },
  { name: 'news-article', auth: 'public', url: 'modules.php?name=News&file=article&sid=1',
  ...
  { name: 'season-leaderboards', auth: 'public', url: 'modules.php?name=Leaderboards&tab=season',
    anchor: '.ibl-data-table', elementScreenshot: true, viewports: ['desktop', 'mobile'] },
  { name: 'head-to-head-records', auth: 'public', url: 'modules.php?name=HeadToHeadRecords',
    anchor: '.h2h-matrix', viewports: ['desktop', 'mobile'] },
  { name: 'standings', auth: 'public', url: 'modules.php?name=Standings',
    anchor: '.ibl-data-table', viewports: ['desktop', 'mobile'] },
  { name: 'strength-of-schedule', auth: 'public', url: 'modules.php?name=Schedule',
    anchor: '.sos-legend', viewports: ['desktop', 'mobile'],
    notes: 'SOS tier legend in the Schedule page (StrengthOfSchedule is not a standalone module; SOS classes render within LeagueScheduleView).' },
  ...
  { name: 'team-contracts', auth: 'public', url: 'modules.php?name=Team&op=team&teamid=1&display=contracts',
    anchor: '.ibl-data-table', viewports: ['desktop', 'mobile'],
    notes: 'contracts tab -- exercises contract-hint.js layout; requires update-baselines on first run' },
  ...
  { name: 'block-fa-admin', auth: 'auth', url: 'block.php',
    anchor: '.block-fa-day-banner', viewports: ['desktop'],
    notes: 'Admin FA blocking interface; discord link color changed (#7289da → var(--discord)).' },
  ...
  { name: 'free-agency', auth: 'auth', url: 'modules.php?name=FreeAgency',
    ...
    viewports: ['desktop', 'mobile'],
    dataDriven: true },
  { name: 'game-boxscore', auth: 'public', url: 'modules.php?name=GameBoxscore&date=2026-02-20&game=1',
    anchor: '[data-team-panel="home"]', viewports: ['desktop', 'mobile'],
    notes: 'Home-team panel is visible by default (home radio checked); away panel starts hidden. Public page, no auth required.' },
  ...
  { name: 'api-keys-guide', auth: 'auth-regular', url: 'modules.php?name=ApiKeys',
    anchor: '.ibl-card',
    notes: 'Player Export guide now renders below the key card on the ApiKeys page.' },
  { name: 'voting-admin-results', auth: 'auth', url: 'modules.php?name=Voting',
    anchor: '[onclick="ShowAndHideResults()"]',
    notes: 'Admin-only results expander; .voting-category alone matches every ballot category.' },
