...
define("_COMMENTSWARNING", "Alle kommentarer tilh�rer indsenderen. Vi er ikke ansvarlige for indholdet og kan ikke tages som udtryk for vores synspunkter.");
define("_SCORE", "Hits:");
define("_USERINFO", "Brugerinfo");
define("_READREST", "L�s resten af denne kommentar...");
define("_REPLY", "Svar til denne");
define("_REPLYMAIN", "Send kommentar");
define("_NOSUBJECT", "Intet emne");
define("_NOANONCOMMENTS", "Anonyme kan ikke skrive kommentarer. V�r venlig at <a href=\"modules.php?name=Your_Account&amp;op=new_user\">oprette</a> dig som bruger.");
define("_PARENT", "Forrige");
define("_ROOT", "Rod");
define("_UCOMMENT", "Kommentar");
define("_ALLOWEDHTML", "Tilladte HTML-koder:");
define("_POSTANON", "Anonymt indl�g");
...
define("_CURRENTSURVEY", "Nuv�rende afstemning");
define("_CURRENTPOLLRESULTS", "Nuv�rende afstemningsresultater");
define("_PREVIEW", "Gennemse");
define("_REFRESH", "Genopfrisk");
define("_SURVEYS", "Afstemninger");
define("_ATTACHEDTOARTICLE", "- vedh�ftet til artiklen:");
define("_SURVEYSATTACHED", "Afstemninger vedh�ftet til artikler");
