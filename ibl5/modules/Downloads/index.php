...
function convertorderbytrans($orderby)
{
    ...
    if ($orderby == "downloadratingsummary ASC") {
        $orderbyTrans = "" . _RATING1 . "";
    }

    if ($orderby == "downloadratingsummary DESC") {
...
function completevote($error)
{
    ...
    include "modules/$module_name/d_config.php";
    if ($error == "none") {
        echo "<center><font class=\"content\"><b>" . _COMPLETEVOTE1 . "</b></font></center>";
    }

    if ($error == "anonflood") {
        echo "<center><font class=\"option\"><b>" . _COMPLETEVOTE2 . "</b></font></center><br>";
    }

    if ($error == "regflood") {
        echo "<center><font class=\"option\"><b>" . _COMPLETEVOTE3 . "</b></font></center><br>";
    }

    if ($error == "postervote") {
        echo "<center><font class=\"option\"><b>" . _COMPLETEVOTE4 . "</b></font></center><br>";
    }

    if ($error == "nullerror") {
        echo "<center><font class=\"option\"><b>" . _COMPLETEVOTE5 . "</b></font></center><br>";
    }

    if ($error == "outsideflood") {
        echo "<center><font class=\"option\"><b>" . _COMPLETEVOTE6 . "</b></font></center><br>";
    }
