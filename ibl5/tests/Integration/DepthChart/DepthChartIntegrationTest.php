...
namespace Tests\Integration\DepthChart;
 ...
 *
 * @covers \DepthChart\DepthChartRepository
 * @covers \DepthChart\DepthChartProcessor
 * @covers \DepthChart\DepthChartValidator
 */
class DepthChartIntegrationTest extends IntegrationTestCase
{
    private DepthChartRepository $repository;
    private DepthChartProcessor $processor;
    private DepthChartValidator $validator;
