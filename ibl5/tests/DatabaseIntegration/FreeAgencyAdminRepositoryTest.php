...
class FreeAgencyAdminRepositoryTest extends DatabaseTestCase
{
    ...
    {
        $this->insertTestPlayer(200060001, 'FA Offer Player', ['teamid' => 0, 'bird' => 5]);
    ...
    public function testGetAllOffersWithBirdYearsReturnsEmptyAfterClearing(): void
    {
        ...
        $this->insertTestPlayer(200060008, 'FA Empty Test', ['teamid' => 0, 'bird' => 2]);
    ...
    {
        $this->insertTestPlayer(200060006, 'FA Clear P1', ['teamid' => 0]);
        $this->insertTestPlayer(200060007, 'FA Clear P2', ['teamid' => 0]);
