...
foreach ($games as $game) {
    ...
    if ($isUpdate) {
        ...
        $repository->insertTeamBoxscore([
            'game_date' => $date,
            'name' => $parsed['visitorTotal']['name'],
            'game_of_that_day' => $gameOfDay,
            'visitor_teamid' => $visitorTid,
            'home_teamid' => $homeTid,
            'attendance' => $parsed['attendance'],
            'capacity' => $parsed['capacity'],
            'visitor_wins' => $parsed['visitor_wins'],
            'visitor_losses' => $parsed['visitor_losses'],
            'home_wins' => $parsed['home_wins'],
            'home_losses' => $parsed['home_losses'],
            'visitor_q1_points' => $parsed['visitorQ1'],
            'visitor_q2_points' => $parsed['visitorQ2'],
            'visitor_q3_points' => $parsed['visitorQ3'],
            'visitor_q4_points' => $parsed['visitorQ4'],
            'visitor_ot_points' => $parsed['visitorOT'],
            'home_q1_points' => $parsed['homeQ1'],
            'home_q2_points' => $parsed['homeQ2'],
            'home_q3_points' => $parsed['homeQ3'],
            'home_q4_points' => $parsed['homeQ4'],
            'home_ot_points' => $parsed['homeOT'],
            'game_2gm' => $parsed['visitorTotal']['fgm'],
            'game_2ga' => $parsed['visitorTotal']['fga'],
            'game_ftm' => $parsed['visitorTotal']['ftm'],
            'game_fta' => $parsed['visitorTotal']['fta'],
            'game_3gm' => $parsed['visitorTotal']['tpm'],
            'game_3ga' => $parsed['visitorTotal']['tpa'],
            'game_orb' => $parsed['visitorTotal']['oreb'],
            'game_drb' => $parsed['visitorTotal']['dreb'],
            'game_ast' => $parsed['visitorTotal']['ast'],
            'game_stl' => $parsed['visitorTotal']['stl'],
            'game_tov' => $parsed['visitorTotal']['tov'],
            'game_blk' => $parsed['visitorTotal']['blk'],
            'game_pf' => $parsed['visitorTotal']['pf'],
        ]);

        // Insert home team total
        $repository->insertTeamBoxscore([
            'game_date' => $date,
            'name' => $parsed['homeTotal']['name'],
            'game_of_that_day' => $gameOfDay,
            'visitor_teamid' => $visitorTid,
            'home_teamid' => $homeTid,
            'attendance' => $parsed['attendance'],
            ...
            'home_q4_points' => $parsed['homeQ4'],
            'home_ot_points' => $parsed['homeOT'],
            'game_2gm' => $parsed['homeTotal']['fgm'],
            'game_2ga' => $parsed['homeTotal']['fga'],
            'game_ftm' => $parsed['homeTotal']['ftm'],
            'game_fta' => $parsed['homeTotal']['fta'],
            'game_3gm' => $parsed['homeTotal']['tpm'],
            'game_3ga' => $parsed['homeTotal']['tpa'],
            'game_orb' => $parsed['homeTotal']['oreb'],
            'game_drb' => $parsed['homeTotal']['dreb'],
            'game_ast' => $parsed['homeTotal']['ast'],
            'game_stl' => $parsed['homeTotal']['stl'],
            'game_tov' => $parsed['homeTotal']['tov'],
            'game_blk' => $parsed['homeTotal']['blk'],
            'game_pf' => $parsed['homeTotal']['pf'],
        ]);
