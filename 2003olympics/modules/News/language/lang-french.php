...
define("_CONSIDERED", "a trouv� l'article suivant int�ressant et a souhait� vous l'envoyer.");
define("_FDATE", "Date:");
define("_FTOPIC", "Sujet:");
define("_YOUCANREAD", "Vous pouvez lire d'autres articles int�ressant sur");
...
define("_ADD", "Ajouter");
define("_NOCOMMENTSACT", "D�sol�, les Commentaires ne sont pas autoris�s pour cet article.");
