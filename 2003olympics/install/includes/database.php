...
class database
{
     ...
     */
    public function database($host = 'localhost', $user, $pass, $db = '', $table_prefix = '', $goOffline = true)
    {
...
//echo 'D: ' . $this->_db->getQuery();
     ...
     * @return boolean
     */
    public function isCheckedOut($user_id = 0)
    {
        if ($user_id) {
     ...
     */
    public function publish_array($cid = null, $publish = 1, $user_id = 0)
    {
