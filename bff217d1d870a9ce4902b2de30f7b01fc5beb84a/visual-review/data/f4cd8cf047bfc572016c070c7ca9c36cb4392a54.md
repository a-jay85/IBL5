...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> activity-tracker
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=ActivityTracker", waiting until "load"
