...
define("_OLDERARTICLES", "�ldre artikler");
define("_BY", "af");
define("_ON", "Dato:");
...
define("_ASREGISTERED", "Er du endnu ikke oprettet som bruger? Du kan gratis <a href=\"modules.php?name=Your_Account\">oprette</a> en brugerkonto. Som bruger kan du �ndre udseende p� websitet, �ndre ops�tning, skrive kommentarer i dit eget navn og modtage vores nyhedsbrev.");
define("_MENUFOR", "Menu for");
define("_NOBIGSTORY", "Der er endnu ikke nogen Dagens artikel.");
define("_BIGSTORY", "Dagens mest l�ste artikel er:");
define("_SURVEY", "Afstemning");
define("_POLLS", "Afstemninger");
define("_PCOMMENTS", "Kommentarer:");
define("_RESULTS", "Resultat");
define("_HREADMORE", "l�s mere...");
define("_CURRENTLY", "Lige nu er der");
define("_GUESTS", "g�st(er) og ");
...
define("_MVIEWALL", "Kan ses af alle bes�gende");
define("_EXPIRELESSHOUR", "Udl�bstidspunkt: Om mindre end 1 time");
define("_EXPIREIN", "Udl�ber om");
define("_HTTPREFERERS", "Hvem linker til sitet");
define("_UNLIMITED", "Ubegr�nset");
define("_HOURS", "Timer");
define("_RSSPROBLEM", "Der er i �jeblikket problemer med at modtage overskrifter fra dette website.");
define("_SELECTLANGUAGE", "V�lg sprog");
define("_SELECTGUILANG", "V�lg sprog:");
define("_NONE", "Ingen");
...
define("_MODULENOTACTIVE", "Desv�re, dette modul er ikke aktiveret!");
...
define("_RESTRICTEDAREA", "De fors�ger at f� adgang til et beskyttet omr�de.");
define("_MODULEUSERS", "Desv�rre men den her del af siden er kun for <i>Tilmeldte brugere</i><br><br>De kan dog GRATIS blive medlem ved at trykke <a href=\"modules.php?name=Your_Account&op=new_user\">her</a>, s� kan de bagefter f�<br> adgang til dette omr�de.<br><br>");
define("_MODULESADMINS", "Desv�rre men denne del af siden er kun for <i>Webmastere</i><br><br>");
define("_HOME", "Hjem");
define("_HOMEPROBLEM", "Her er et stort problem: vi har ingen hjemmeside!!!");
define("_ADDAHOME", "TIlf�j et modul til deres \"Hjem\".");
define("_HOMEPROBLEMUSER", "Der er ligenu et problem p� siden. V�r venlig at komme tilbage senere.");
...
define("_BUNREAD", "Uafl�st");
define("_BREAD", "L�s");
define("_BMEMP", "Medlemskab");
define("_BLATEST", "Nyeste");
define("_BTD", "Ny i dag");
define("_BYD", "Ny i g�r");
define("_BOVER", "Overalt");
define("_BVISIT", "Bes�gende online");
define("_BVIS", "Bes�gende");
...
define("_THISISAUTOMATED", "Dette er en automatisk e-mail for at fort�lle Dem at deres banner annonsering p� vores side: &sitename , netop er slut.");
define("_THERESULTS", "Resultaterne af deres kampagne er f�lgende:");
...
define("_HOPEYOULIKED", "Vi h�ber De er tilfredse med vores service. Og vi vil se frem til et evt. nyt samarbejde.");
define("_THANKSUPPORT", "Tak for deres support");
define("_TEAM", "Team");
define("_BANNERSFINNISHED", "Afsluttede bannere");
define("_MODREQLINKS", "Mod. links");
define("_BROKENLINKS", "�delagt link");
define("_MODREQDOWN", "Mod. downloads");
define("_BROKENDOWN", "�delagt download");
define("_PAGEGENERATION", "Siden blev lavet p�:");
