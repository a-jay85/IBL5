...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> career-leaderboards
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  74923 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: career-leaderboards.png

Call log:
  - Expect "toHaveScreenshot(career-leaderboards.png)" with timeout 10000ms
...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e70]:
    ...
    - heading "Career Leaderboards" [level=1] [ref=f1e74]
    - generic [ref=f1e76]:
      - generic [ref=f1e77]:
        - generic [ref=f1e78]: "Type:"
        - combobox "Type:" [ref=f1e79]:
      ...
      - generic [ref=f1e80]:
        - generic [ref=f1e81]: "Category:"
        - combobox "Category:" [ref=f1e82]:
      ...
      - generic [ref=f1e83]:
        - generic [ref=f1e84]: "Include Retirees:"
        - combobox "Include Retirees:" [ref=f1e85]:
          - option "Yes" [selected]
          - option "No"
      - generic [ref=f1e86]:
      ...
      - button "Display Career Leaderboards" [ref=f1e90] [cursor=pointer]
```
