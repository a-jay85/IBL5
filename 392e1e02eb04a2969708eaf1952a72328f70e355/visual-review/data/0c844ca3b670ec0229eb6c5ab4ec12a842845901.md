...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> draft-pick-locator
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=DraftPickLocator", waiting until "load"
