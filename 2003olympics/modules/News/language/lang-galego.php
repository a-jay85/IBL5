...
define("_MOREABOUT", "M�is acerca de");
define("_NEWSBY", "Noticias de");
define("_MOSTREAD", "Noticia m�is l�da sobre");
define("_READMORE", "Ler m�is...");
define("_BYTESMORE", "bytes m�is");
...
define("_NOANONCOMMENTS", "Non se permiten comentarios An�nimos, <a href=\"modules.php?name=Your_Account&amp;op=new_user\">rex�strese</a> por favor");
define("_PARENT", "Pai");
define("_ROOT", "Ra�z");
define("_UCOMMENT", "Comentario");
define("_ALLOWEDHTML", "Permitir HTML:");
define("_POSTANON", "Env�o An�nimo");
...
define("_NOTRIGHT", "Algo non funcionou � pasar unha variable � s�a funci�n. Esta mensaxe � para manter as cousas no seu sitio");
define("_SENDAMSG", "Enviar unha mensaxe");
define("_YOUSENDSTORY", "Vostede enviar� a noticia");
...
define("_THEURL", "A direcci�n desta noticia �:");
define("_PREVIEW", "Vista Previa");
define("_NEWUSER", "Novo Usuario");
define("_OPTIONS", "Opci�ns");
define("_REFRESH", "Recargar");
define("_ADD", "Engadir");
define("_NOCOMMENTSACT", "Desculpe, os Comentarios non est�n permitidos para este artigo.");
