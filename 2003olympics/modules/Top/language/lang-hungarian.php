...
define("_COMMENTEDSTORIES", "legt�bb hozz�sz�l�ssal rendelkez� cikkek toplist�ja");
define("_ACTIVECAT", "legakt�vabb kateg�ri�k toplist�ja");
define("_READSECTION", "a k�l�nleges t�m�k legolvasottabb cikkeinek toplist�ja");
define("_NEWSSUBMITTERS", "a legakt�vabb szerz�k toplist�ja");
define("_NEWSSENT", "bek�ld�tt h�r");
