...
-- Showcase stats
ALTER TABLE ibl_plr
  MODIFY sh_pts SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Season high points',
  MODIFY sh_reb SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Season high rebounds',
  MODIFY sh_ast SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Season high assists',
  MODIFY sh_stl SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Season high steals',
  MODIFY sh_blk SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Season high blocks',
  MODIFY sp_pts SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Playoff high points',
  MODIFY sp_reb SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Playoff high rebounds',
  MODIFY sp_ast SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Playoff high assists',
  MODIFY sp_stl SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Playoff high steals',
  MODIFY sp_blk SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Playoff high blocks',
  MODIFY ch_pts SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career high points',
  MODIFY ch_reb SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career high rebounds',
  MODIFY ch_ast SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career high assists',
  MODIFY ch_stl SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career high steals',
  MODIFY ch_blk SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career high blocks',
  MODIFY cp_pts SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career playoff high points',
  MODIFY cp_reb SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career playoff high rebounds',
  MODIFY cp_ast SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career playoff high assists',
  MODIFY cp_stl SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career playoff high steals',
  MODIFY cp_blk SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Career playoff high blocks';
...
ALTER TABLE ibl_plr
  MODIFY r_fga SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating FGA',
  MODIFY r_fgp SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating FG%',
  MODIFY r_fta SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating FTA',
  MODIFY r_ftp SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating FT%',
  MODIFY r_tga SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating 3PA',
  MODIFY r_tgp SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating 3P%',
  MODIFY r_orb SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating ORB',
  MODIFY r_drb SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating DRB',
  MODIFY r_ast SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating AST',
  MODIFY r_stl SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating STL',
  MODIFY r_to SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating TO',
  MODIFY r_blk SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating BLK',
  MODIFY r_foul SMALLINT UNSIGNED DEFAULT 0 COMMENT 'Rating fouls';
...
ALTER TABLE ibl_draft_class
  ...
  MODIFY oo TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Off outside rating',
  MODIFY do TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Off drive rating',
  MODIFY po TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Off post rating',
  MODIFY `to` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Off transition rating',
  MODIFY od TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Def outside rating',
  MODIFY dd TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Def drive rating',
  MODIFY pd TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Def post rating',
  MODIFY td TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Def transition rating';
...
ALTER TABLE ibl_plr
  ...
  ADD CONSTRAINT chk_plr_cy2 CHECK (cy2 >= -7000 AND cy2 <= 7000),
