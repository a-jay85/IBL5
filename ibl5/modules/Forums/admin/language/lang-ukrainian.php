...
define("_ONLINEMANUAL", "������ Online (English)");
define("_ADMINLOGOUT", "�����");
define("_LAST", "�������");
define("_GO", "������!");
define("_CURRENTPOLL", "������� �����������");
...
define("_BANNERSNOTACTIVE", "������� ����������� � ���� config.php.");
...
define("_BLOCKUP", "���� �����");
define("_BLOCKDOWN", "���� ����");
define("_SETUPHEADLINES", "(������� ''Custom'' � ������ URL ��� ������ ������� ���� � ������)");
...
define("_DELCATWARNING1", "�� ������ ������� �� �������� � �Ѳ ����� � ��� � �� �������� �� ���");
define("_DELCATWARNING2", "�� �� ������ ���������� �Ѳ����� � ���� ��������.");
define("_DELCATWARNING3", "�� �� ������ �������?");
define("_YESDEL", "���! ������� ���!");
define("_NOMOVE", "Ͳ! ���������� �� �����");
define("_MOVESTORIES", "���������� �� ����� � ���� ��������");
define("_ALLSTORIES", "�Ѳ ����� �");
define("_WILLBEMOVED", "����� ���������.");
...
define("_WHOLINKS", "� ���� ����� �� ��� �������");
define("_DELETEREFERERS", "�������� Referers");
define("_POLLSADMIN", "�������������� ����������");
define("_CREATEPOLL", "�������� ���� �����������");
define("_DELETEPOLLS", "������� �����������");
define("_POLLTITLE", "����� �����������");
...
define("_DOWNLOADVALIDATION", "ϳ����������� �����");
define("_CHECKALLDOWNLOADS", "��������� �Ѳ �����");
define("_VALIDATEDOWNLOADS", "ϳ��������� �����");
