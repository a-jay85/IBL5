...
define("_CLIENTPASSWD", "Contrase�a del Cliente");
...
define("_CLASS", "Clase");
define("_CLASSNOTE", "Si tu Clase de Banner es C�digo Javascript/HTML los siguientes 3 campos ser�n ignorados y s�lo se tomar� en cuenta el campo de c�digo. Si tu Clase de Banner es Flash debes especificar el URL completo del archivo .SWF en el campo que sigue (Los campos URL para el Click y Texto Alterno ser�n ignorados.");
define("_ADCLASS", "Class de Banner");
define("_ADIMAGE", "Imagen");
define("_ADCODE", "C�digo Javascript/HTML");
define("_ADFLASH", "Flash");
define("_IMAGESIZE", "Tama�o de Imagen");
define("_WIDTH", "Ancho");
define("_HEIGHT", "Alto");
define("_INPIXELS", "(tama�o en pixels)");
define("_FLASHFILEURL", "URL de Archivo Flash");
define("_FLASHSIZE", "Tama�o del Flash");
