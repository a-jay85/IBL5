...
define("_ASREGISTERED", "Voc� ainda n�o tem uma conta? Pode criar uma <a href=\"modules.php?name=Your_Account&op=new_user\"><b>aqui</b></a>. Como utilizador registado, pode configurar o web site de acordo com as suas prefer�ncias, al�m de ter outras vantagens exclusivas.");
define("_MENUFOR", "Menu");
define("_NOBIGSTORY", "Hoje ainda n�o apareceu um artigo.");
define("_BIGSTORY", "O artigo mais lido de hoje �:");
define("_SURVEY", "Vota��o");
define("_POLLS", "Vota��o");
define("_PCOMMENTS", "Coment�rios:");
define("_RESULTS", "Resultados");
define("_HREADMORE", "leia mais...");
define("_CURRENTLY", "neste momento est�o online");
define("_GUESTS", "visitante(s) ");
define("_MEMBERS", "utilizador(es).");
define("_YOUARELOGGED", "Voc� est� ligado como");
define("_YOUHAVE", "Voc� tem");
define("_PRIVATEMSG", "mensagem(s) na sua caixa de entrada.");
define("_YOUAREANON", "Voc� ainda n�o � nosso utilizador. � gr�tis! Clique <a href=\"modules.php?name=Your_Account&op=new_user\"><b>aqui</b></a>");
define("_NOTE", "Nota:");
define("_ADMIN", "Admin:");
...
define("_HOURS", "Horas");
define("_RSSPROBLEM", "Actualmente h� um problema com os cabe�alhos deste site");
define("_SELECTLANGUAGE", "Seleccionar Idioma");
define("_SELECTGUILANG", "Seleccionar a Interface do Idioma:");
define("_NONE", "Nenhum");
define("_BLOCKPROBLEM", "<center>H� um problema agora com este bloco.</center>");
define("_BLOCKPROBLEM2", "<center>Neste momento n�o existe conte�do para este bloco.</center>");
define("_MODULENOTACTIVE", "Desculpe, este m�dulo n�o est� activo!");
...
define("_RESTRICTEDAREA", "Voc� tentou aceder a uma �rea restricta.");
define("_MODULEUSERS", "Pedimos desculpa, mas esta sec��o do nosso site � somente para<i>Utlizadores Registados</i> <br><br>Voc� pode-se registar de gra�a clicando <a href=\"modules.php?name=Your_Account&op=new_user\"><b>here</b></a>, depois poder�<br>aceder a esta sec��o sem restric��es. Obrigado.<br><br>");
define("_MODULESADMINS", "Pedimos desculpa mas esta sec��o do nosso site � somente para <i>Administradores</i><br><br>");
define("_HOME", "Home");
define("_HOMEPROBLEM", "Existe aqui um grande problema: N�o se tem uma Homepage!!!");
define("_ADDAHOME", "Adicione um M�dulo na sua Home");
define("_HOMEPROBLEMUSER", "Existe de momento um problema com a p�gina. Por favor volte mais tarde.");
define("_MORENEWS", "Mais na sec��o de Not�cias");
...
define("_THISISAUTOMATED", "Esta � uma mensagem autom�tica para voc� saber que o seu banner publicit�rio no nosso site expirou o seu \"tempo de audi�ncia\".");
define("_THERESULTS", "Os resultados da sua campanha foi o seguinte:");
define("_TOTALIMPRESSIONS", "Impress�o Total Feita:");
...
define("_HOPEYOULIKED", "Esperamos que tenha gostado do nosso servi�o. Estaremos sempre aqui ao seu disp�r caso queira ser nosso cliente publicit�rio novamente.");
...
define("_PAGEGENERATION", "Gera��o da P�gina:");
define("_CHAT", "Chat");
