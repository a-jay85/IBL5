...
define("_SIZE", "M�ret");
define("_DOWNLOADSINDB", "let�lt�s van az adatb�zisunkban");
define("_DOWNLOADSWAITINGVAL", "J�v�hagy�sra v�r� let�lt�sek");
define("_CLEANDOWNLOADSDB", "Let�lt�si szavazatok t�rl�se");
define("_BROKENDOWNLOADSREP", "Hib�s let�lt�s bejelent�se");
define("_DOWNLOADMODREQUEST", "K�relmek let�lt�s v�ltoztat�s�ra");
define("_ADDNEWDOWNLOAD", "�j let�lt�s hozz�ad�sa");
define("_MODDOWNLOAD", "Let�lt�s szerkeszt�se");
define("_WEBDOWNLOADSADMIN", "Let�lt�sek adminisztr�l�sa");
define("_DNOREPORTEDBROKEN", "Senki sem jelentett hib�s let�lt�st.");
define("_DUSERREPBROKEN", "Felhaszn�l�k �ltal jelentett hib�s let�lt�sek");
define("_DIGNOREINFO", "M�gsem (T�rli az adott linkre vonatkoz� <b><i>�sszes t�rl�si k�relmet</i></b>)");
define("_DDELETEINFO", "T�rl�s (T�rli a <b><i>hib�s linket</i></b> �s a r� vonatkoz� <b><i>k�r�seket</i></b>)");
define("_DOWNLOADOWNER", "Let�lt�s tulajdonosa");
define("_DUSERMODREQUEST", "Felhaszn�l�k v�ltoztat�si k�relmei");
define("_DOWNLOADVALIDATION", "Let�lt�sek ellen�rz�se");
define("_CHECKALLDOWNLOADS", "MINDEN let�lt�s ellen�rz�se");
define("_VALIDATEDOWNLOADS", "Let�lt�sek ellen�rz�se");
define("_NEWDOWNLOADADDED", "�j let�lt�s felv�ve az adatb�zisunkba");
