...
define("_RSSCONTENT", "(RSS/RDF sis�lt�)");
define("_IFRSSWARNING", "Jos laitat URL kentt��n jotain, niin yll�olevaa sis�lt�� ei n�ytet�!");
define("_BLOCKUP", "Blokki Yl�sp�in");
...
define("_REQUIREDNOCHANGE", "(Vaadittu, EIK� voidan vaihtaa j�lkik�teen)");
...
define("_TOPICNAME1", "(Nimi ilman v�lily�ntej� - max 20 merkki�)");
...
define("_ADMINEMAIL", "Yll�pit�j�n s�hk�postiosoite");
...
define("_NOTIFYSUBMISSION", "L�het� s�hk�postilla huomio uudesta materiaalista?");
define("_EMAIL2SENDMSG", "Mihin s�hk�postiosoitteeseen");
...
define("_ADMINGRAPHIC", "N�ytet��nk� yll�pidon teht�v�t kuvina?");
