...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> error-nonexistent-file
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=Standings&file=nonexistent", waiting until "load"
