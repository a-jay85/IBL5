...
class NegotiationRepository extends BaseMysqliRepository implements NegotiationRepositoryInterface
{
    ...
    {
        return $this->salaryCapRepo->getTeamCapSpaceNextSeason($teamName);
    }
