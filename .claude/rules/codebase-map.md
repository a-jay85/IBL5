...
| Updater | 16 | Y | R1 S1 V1 Ct1 | Steps |
| Utilities | 6 | - |  |  |
| Validation | 3 | - | Vl1 |  |
...
Boxscore -> JSB JsbParser League Player Season Security Updater Utilities mysqli
BulkImport -> BasketballStats Boxscore JsbParser LeagueConfig PlrParser
Cache -> Clock
