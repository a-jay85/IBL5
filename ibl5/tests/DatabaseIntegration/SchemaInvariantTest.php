...
class SchemaInvariantTest extends DatabaseTestCase
{
    ...
    private const KNOWN_COLUMNS_WITHOUT_FK = [
        ...
        'ibl_box_scores_phantom_backup.home_teamid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_phantom_backup.pid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_phantom_backup.teamid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_phantom_backup.visitor_teamid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_teams_phantom_backup.home_teamid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_teams_phantom_backup.visitor_teamid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_sim_game_recaps_phantom_backup.home_teamid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_sim_game_recaps_phantom_backup.visitor_teamid' => 'phantom-repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_season2004_backup.home_teamid' => 'season-2004 repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_season2004_backup.pid' => 'season-2004 repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_season2004_backup.teamid' => 'season-2004 repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_season2004_backup.visitor_teamid' => 'season-2004 repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_teams_season2004_backup.home_teamid' => 'season-2004 repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_teams_season2004_backup.visitor_teamid' => 'season-2004 repair undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback script restores from',
        'ibl_box_scores_season1993_phantom_backup.home_teamid' => 'season-1993 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_season1993_phantom_backup.pid' => 'season-1993 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_season1993_phantom_backup.teamid' => 'season-1993 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_season1993_phantom_backup.visitor_teamid' => 'season-1993 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_teams_season1993_phantom_backup.home_teamid' => 'season-1993 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_teams_season1993_phantom_backup.visitor_teamid' => 'season-1993 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_season2007_phantom_backup.home_teamid' => 'season-2007 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_season2007_phantom_backup.pid' => 'season-2007 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_season2007_phantom_backup.teamid' => 'season-2007 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_season2007_phantom_backup.visitor_teamid' => 'season-2007 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_teams_season2007_phantom_backup.home_teamid' => 'season-2007 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
        'ibl_box_scores_teams_season2007_phantom_backup.visitor_teamid' => 'season-2007 phantom-delete undo record; deliberately FK-free so an ON DELETE CASCADE from ibl_plr / ibl_team_info can never erase the rows the rollback restores from',
