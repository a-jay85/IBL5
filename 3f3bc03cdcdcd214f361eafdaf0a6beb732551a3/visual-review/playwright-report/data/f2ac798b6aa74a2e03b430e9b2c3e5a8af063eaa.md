...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> voting-eoy-fa-mobile
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: voting-eoy-fa-mobile.png

Call log:
  - Expect "toHaveScreenshot(voting-eoy-fa-mobile.png)" with timeout 10000ms
