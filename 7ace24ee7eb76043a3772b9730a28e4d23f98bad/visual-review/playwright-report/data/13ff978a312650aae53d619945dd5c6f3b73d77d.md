...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  2384 pixels (ratio 0.01 of all image pixels) are different.
...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e26]:
    ...
    - generic [ref=f1e28]:
      - generic [ref=f1e29]:
        - generic [ref=f1e30]: Dimension
        - combobox "Dimension" [ref=f1e31]:
          - option "Franchises" [selected]
          - option "Teams"
          - option "GMs"
      - generic [ref=f1e32]:
        - generic [ref=f1e33]: Phase
        - combobox "Phase" [ref=f1e34]:
          - option "HEAT"
      ...
      - generic [ref=f1e35]:
        ...
        - combobox "Scope" [ref=f1e37]:
          - option "Current Season" [selected]
          - option "All-Time"
      - button "Filter" [ref=f1e38] [cursor=pointer]
    - table [ref=f1e41]:
      - rowgroup [ref=f1e42]:
        - row [ref=f1e43]:
          - columnheader "Row versus column, shown as wins-losses for the row" [ref=f1e44]:
            - generic [aria-hidden] [ref=f1e46]: →→
            - generic [aria-hidden] [ref=f1e47]: vs.
            - generic [aria-hidden] [ref=f1e48]: ↑
          - columnheader [ref=f1e49]:
            - link "Chicago Cougars" [ref=f1e50] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=3
              - img "Chicago Cougars" [ref=f1e51]
          - columnheader [ref=f1e52]:
            - link "New York Metros" [ref=f1e53] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=1
              - img "New York Metros" [ref=f1e54]
          - columnheader [ref=f1e55]:
            - link "Boston Minutemen" [ref=f1e56] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=5
              - img "Boston Minutemen" [ref=f1e57]
          - columnheader [ref=f1e58]:
            - link "Charlotte Royals" [ref=f1e59] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=12
              - img "Charlotte Royals" [ref=f1e60]
          - columnheader [ref=f1e61]:
            - link "Los Angeles Stars" [ref=f1e62] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=2
              - img "Los Angeles Stars" [ref=f1e63]
      - rowgroup [ref=f1e64]:
        - row [ref=f1e65]:
          - cell [ref=f1e66]:
            - link "Chicago Cougars" [ref=f1e67] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=3
          - cell [ref=f1e68]
          - cell "0-1" [ref=f1e69]
          - cell "0-0" [ref=f1e70]
        ...
        - row [ref=f1e73]:
          - cell [ref=f1e74]:
            - link "New York Metros" [ref=f1e75] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=1
          - cell "1-0" [ref=f1e76]
          - cell [ref=f1e77]
          - cell "0-0" [ref=f1e78]
        ...
        - row [ref=f1e81]:
          - cell [ref=f1e82]:
            - link "Boston Minutemen" [ref=f1e83] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=5
          - cell "0-0" [ref=f1e84]
          - cell "0-0" [ref=f1e85]
          - cell [ref=f1e86]
        ...
        - row [ref=f1e89]:
          - cell [ref=f1e90]:
            - link "Charlotte Royals" [ref=f1e91] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=12
          - cell "0-0" [ref=f1e92]
          - cell "0-0" [ref=f1e93]
          - cell "0-1" [ref=f1e94]
        ...
        - row [ref=f1e97]:
          - cell [ref=f1e98]:
            - link "Los Angeles Stars" [ref=f1e99] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=2
          - cell "0-0" [ref=f1e100]
          - cell "1-4" [ref=f1e101]
          - cell "0-0" [ref=f1e102]
