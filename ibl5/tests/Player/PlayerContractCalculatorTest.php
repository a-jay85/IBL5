...
class PlayerContractCalculatorTest extends TestCase
{
    ...
    // --- Merged from PlayerContractCalculatorEdgeCaseTest ---
    ...
    public function testGetLongBuyoutArrayWithNonDivisibleSalary(): void
    {
        ...
        $this->assertSame($expectedPerYear, $result[1]);
        $this->assertCount(6, $result);
    }
    ...
    public function testYearBoundaryBehavior(int $year, int $expectedSalary): void
    {
        ...
        $this->assertSame($expectedSalary, $result);
    }
    ...
    public function testCalculatorHandlesAllNullProperties(): void
    {
        ...
        $this->assertSame(0, $currentSalary);
        $this->assertSame(0, $nextSalary);
        $this->assertEquals([1 => 0], $remainingArray);
        $this->assertSame(0, $totalRemaining);
