...
define("_INSECTION", "Artikkeli aihepiiriss�");
define("_NONAME", "Nime� ei ole sy�tetty");
...
define("_MATCHTEXT", "Hakusana l�ytyi artikkelin tekstist�");
define("_MATCHBOTH", "Hakusana l�ytyi otsikosta ja artikkelin tekstist�");
