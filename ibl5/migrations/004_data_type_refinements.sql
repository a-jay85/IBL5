...
ALTER TABLE ibl_draft_class
  ...
  MODIFY offo TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Off outside rating',
  MODIFY offd TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Off drive rating',
  ...
  MODIFY defo TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Def outside rating',
  MODIFY defd TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Def drive rating',
