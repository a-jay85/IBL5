...
class MobileNavView
{
    ...
    /**
     * Render the "Signed in as ... / Logout" footer for the mobile My Team
    ...
    private function renderLogoutFooter(): string
    {
        ...
        <div class="px-5 py-3 border-t border-white/10 mt-1">
            ...
            <a href="modules.php?name=YourAccount&amp;op=logout" class="block w-full text-center bg-white/10 text-white text-sm font-medium border border-white/20 rounded-xl px-3 py-2.5 cursor-pointer hover:bg-white/15 hover:border-white/30 transition-all">Logout</a>
        </div>
        <?php
        return (string) ob_get_clean();
    }
