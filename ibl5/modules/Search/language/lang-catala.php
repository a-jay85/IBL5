...
define("_NEXTMATCHES", "Registres Seg�ents");
define("_INSECTION", "a la Secci�");
define("_NONAME", "No has introdu�t un nom");
define("_SCOMMENTS", "Comentaris");
define("_SEARCHRESULTS", "Resultats de la Cerca");
define("_CONTRIBUTEDBY", "Contribuci� de");
define("_UCOMMENTS", "Comentaris");
define("_MATCHTITLE", "Cercar per T�tol");
...
define("_SEARCHINSTORY", "Cercar totos els comentaris de la not�cia:");
