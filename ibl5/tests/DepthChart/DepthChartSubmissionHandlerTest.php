...
/**
 * DepthChartSubmissionHandlerTest - Tests for depth chart form submission handling
 *
 * Tests:
 ...
 */
class DepthChartSubmissionHandlerTest extends TestCase
{
    ...
    {
        $handler = new DepthChartSubmissionHandler($this->mockMysqliDb);
        
        $this->assertInstanceOf(DepthChartSubmissionHandler::class, $handler);
    }
    ...
    public function testHandlerImplementsCorrectInterface(): void
    {
        ...
        $this->assertInstanceOf(
            \DepthChart\Contracts\DepthChartSubmissionHandlerInterface::class,
            $handler
        );
    }
    ...
    {
        $handler1 = new DepthChartSubmissionHandler($this->mockMysqliDb);
        $handler2 = new DepthChartSubmissionHandler($this->mockMysqliDb);
        
        $this->assertInstanceOf(DepthChartSubmissionHandler::class, $handler1);
        $this->assertInstanceOf(DepthChartSubmissionHandler::class, $handler2);
