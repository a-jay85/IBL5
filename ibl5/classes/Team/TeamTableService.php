...
class TeamTableService implements TeamTableServiceInterface
{
    ...
    public static function cashConsiderationToRosterRow(array $cashRow): array
    {
        return [
            ...
            'cy' => $cashRow['cy'] ?? 1,
            'cyt' => $cashRow['cyt'] ?? 1,
            'salary_yr1' => $cashRow['salary_yr1'] ?? 0,
            'salary_yr2' => $cashRow['salary_yr2'] ?? 0,
            'salary_yr3' => $cashRow['salary_yr3'] ?? 0,
            'salary_yr4' => $cashRow['salary_yr4'] ?? 0,
            'salary_yr5' => $cashRow['salary_yr5'] ?? 0,
            'salary_yr6' => $cashRow['salary_yr6'] ?? 0,
            'retired' => 0,
            'droptime' => 0,
            'injured' => null,
            'htft' => 0, 'htin' => 0, 'wt' => 0,
