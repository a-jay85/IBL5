...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 3315px, received 375px by 3672px. 56042 pixels (ratio 0.05 of all image pixels) are different.
  ...
  - main [ref=f1e26]:
    ...
    - generic [ref=f1e36]:
      ...
      - generic [ref=f1e39]:
        ...
        - generic [ref=f1e49]:
          - strong [ref=f1e50]: Your key is part of this URL.
          - text: The web server logs every URL it serves, so it records the key too. Only paste the formula into a sheet you trust. Scripts and other tools should send the key in an
          - code [ref=f1e51]: X-API-Key
          - text: header instead. If the URL gets shared, revoke the key and generate a new one.
        - heading "Column Reference" [level=3] [ref=f1e52]
        - table [ref=f1e53]:
          - rowgroup [ref=f1e54]:
            - row [ref=f1e55]:
              - columnheader "Column" [ref=f1e56]
              - columnheader "Description" [ref=f1e57]
          - rowgroup [ref=f1e58]:
            - row [ref=f1e59]:
              - cell "PID" [ref=f1e60]
              - cell "Player ID" [ref=f1e61]
            - row [ref=f1e62]:
              - cell "Name" [ref=f1e63]
              - cell "Player name" [ref=f1e64]
            - row [ref=f1e65]:
              - cell "Nickname" [ref=f1e66]
              - cell "Player nickname" [ref=f1e67]
            - row [ref=f1e68]:
              - cell "Age" [ref=f1e69]
              - cell "Player age" [ref=f1e70]
            - row [ref=f1e71]:
              - cell "Position" [ref=f1e72]
              - cell "PG, SG, SF, PF, or C" [ref=f1e73]
            - row [ref=f1e74]:
              - cell "Height (ft) / Height (in)" [ref=f1e75]
              - cell "Height in feet and inches" [ref=f1e76]
            - row [ref=f1e77]:
              - cell "Active" [ref=f1e78]
              - cell "1 = on a depth chart, 0 = not" [ref=f1e79]
            - row [ref=f1e80]:
              - cell "Retired" [ref=f1e81]
              - cell "1 = retired, 0 = active" [ref=f1e82]
            - row [ref=f1e83]:
              - cell "Experience" [ref=f1e84]
              - cell "Years of experience" [ref=f1e85]
            - row [ref=f1e86]:
              - cell "Bird Rights" [ref=f1e87]
              - cell "Bird rights status" [ref=f1e88]
            - row [ref=f1e89]:
              - cell "Team ID / Team City / Team Name" [ref=f1e90]
              - cell "Team information (empty for free agents)" [ref=f1e91]
            - row [ref=f1e92]:
              - cell "Owner" [ref=f1e93]
              - cell "Team owner username" [ref=f1e94]
            - row [ref=f1e95]:
              - cell "Contract Year" [ref=f1e96]
              - cell "Current year of contract (1-6, 0 = unsigned)" [ref=f1e97]
            - row [ref=f1e98]:
              - cell "Current Salary" [ref=f1e99]
              - cell "Salary for the current contract year (thousands)" [ref=f1e100]
            - row [ref=f1e101]:
              - cell "Year 1-6 Salary" [ref=f1e102]
              - cell "Full contract breakdown by year (thousands)" [ref=f1e103]
            - row [ref=f1e104]:
              - cell "GP / MIN" [ref=f1e105]
              - cell "Games played / minutes played (season totals)" [ref=f1e106]
            - row [ref=f1e107]:
              - cell "FGM / FGA" [ref=f1e108]
              - cell "Field goals made / attempted (season totals)" [ref=f1e109]
            - row [ref=f1e110]:
              - cell "FTM / FTA" [ref=f1e111]
              - cell "Free throws made / attempted (season totals)" [ref=f1e112]
            - row [ref=f1e113]:
              - cell "3PM / 3PA" [ref=f1e114]
              - cell "Three-pointers made / attempted (season totals)" [ref=f1e115]
            - row [ref=f1e116]:
              - cell "ORB / DRB" [ref=f1e117]
              - cell "Offensive / defensive rebounds (season totals)" [ref=f1e118]
            - row [ref=f1e119]:
              - cell "AST / STL / TO / BLK / PF" [ref=f1e120]
              - cell "Assists, steals, turnovers, blocks, personal fouls (season totals)" [ref=f1e121]
            - row [ref=f1e122]:
              - cell "PPG" [ref=f1e123]
              - cell "Points per game" [ref=f1e124]
            - row [ref=f1e125]:
              - cell "FG% / FT% / 3P%" [ref=f1e126]
              - cell "Shooting percentages" [ref=f1e127]
        - heading "Tips" [level=3] [ref=f1e128]
        - list [ref=f1e129]:
          - listitem [ref=f1e130]: Data refreshes each time Google Sheets recalculates (approximately every hour).
          - listitem [ref=f1e131]: Use Google Sheets' built-in FILTER, SORT, and QUERY functions to slice the data.
          - listitem [ref=f1e132]: Salary values are in thousands (e.g., 1500 = $1,500K).
          - listitem [ref=f1e133]: Stats columns (GP, MIN, FGM, etc.) are season totals. Divide by GP for per-game averages.
        - heading "Key Management" [level=3] [ref=f1e134]
        - paragraph [ref=f1e135]: Visit API Key Management to view, revoke, or regenerate your key. Each user can have one active key at a time.
```
