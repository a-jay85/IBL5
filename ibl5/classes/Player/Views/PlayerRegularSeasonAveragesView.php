...
/**
 * PlayerRegularSeasonAveragesView - Renders regular season averages
 * 
 * @see PlayerPageViewInterface
 */
class PlayerRegularSeasonAveragesView implements PlayerPageViewInterface
{
    ...
    public function render(): string
    {
        ...
        $historicalStats = $this->statsRepository->getHistoricalStats($this->player->playerID, 'regular');
...
<table border=1 cellspacing=0 class="sortable" style='margin: 0 auto;'>
    <tr>
        <td colspan=17 style='font-weight:bold; text-align:center; background-color:#00c; color:#fff;'>Regular Season Averages</td>
    </tr>
    <tr>
        <th>year</th>
        <th>team</th>
