...
export const VR_MANIFEST: VrRow[] = [
  ...
  { name: 'injuries', auth: 'public', url: 'modules.php?name=Injuries',
    anchor: '.ibl-data-table', viewports: ['desktop', 'mobile'] },
  { name: 'last-sim-recap', auth: 'public', url: 'modules.php?name=LastSimRecap',
    anchor: '.last-sim-recap', viewports: ['desktop', 'mobile'],
    skipContentCheck: true,
    notes: 'Recap panel; content changes each sim.' },
  ...
  { name: 'standings', auth: 'public', url: 'modules.php?name=Standings',
    anchor: '.ibl-data-table', viewports: ['desktop', 'mobile'] },
  { name: 'strength-of-schedule', auth: 'public', url: 'modules.php?name=StrengthOfSchedule',
    anchor: '.ibl-data-table', viewports: ['desktop', 'mobile'] },
