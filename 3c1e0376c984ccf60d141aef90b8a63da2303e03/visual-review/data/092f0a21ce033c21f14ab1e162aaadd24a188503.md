...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> transaction-history-mobile
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=TransactionHistory", waiting until "load"
