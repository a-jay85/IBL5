...
define("_PREVIOUS", "F�reg�ende Sida");
define("_MEMBERSLIST", "Medlemslista");
define("_GREETINGS", "En speciell h�lsning till v�r senast registrerade medlem:");
define("_SORTBY", "Sortera efter:");
define("_MNICKNAME", "alias");
define("_MREALNAME", "namn");
define("_MEMAIL", "e-postadress");
define("_MURL", "url");
define("_ONLINEREG", "Medlemmar som �r online just nu:");
define("_WEHAVE", "Vi har f�r n�rvarande");
define("_MREGISTERED", "registrerade medlemmar. Av dem �r");
