...
define("_HOPEYOULIKED", "Wir hoffen, Sie m�gen unseren Service. Wir hoffen, Sie bald wieder als einen unserer Kunden begr�ssen zu d�rfen.");
define("_THANKSUPPORT", "Danke f�r Ihre Unterst�tzung");
define("_TEAM", "Team");
