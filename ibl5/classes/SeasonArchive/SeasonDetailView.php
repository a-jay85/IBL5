...
use SeasonArchive\Contracts\SeasonDetailViewInterface;

/**
 * SeasonDetailView - HTML rendering for the season detail page
 *
 * Generates all ~12 sections for an individual season detail page.
 ...
 *
 * @see SeasonDetailViewInterface For the interface contract
 */
class SeasonDetailView implements SeasonDetailViewInterface
{
    ...
    /**
     * @see SeasonDetailViewInterface::renderSeasonDetail()
     *
