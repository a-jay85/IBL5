...
**Status (2026-07-12):** ✅ Implemented — ADR-0084. Full detail: [archive](archive/jsb-native-backlog-archive.md#j15-faithful-foul-bucket-program-live-composites--hca-re-homing--level-re-anchor).
...
**Status (2026-07-12):** ✅ Implemented — item (1) resolved inside J15 program (ADR-0084); items (2)–(4) + retention re-trace spun forward as follow-on objdump session. Full detail: [archive](archive/jsb-native-backlog-archive.md#j19-j6-residue-re-energy-operands-rec0x18-semantics-escape-re-derivation-0xd58).
