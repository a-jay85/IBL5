...
/**
 * Trading_CashTransactionHandlerInterface - Cash transaction management for trades
 *
 ...
 */
interface Trading_CashTransactionHandlerInterface
{
    /**
     ...
     *
     * @param array $cashYear Array of cash amounts indexed by year (1-6)
     ...
     * @param array $cashYear Cash amounts indexed by year (1-6)
     ...
     * @param string $offeringTeamName Name of team sending the cash
     * @param string $listeningTeamName Name of team receiving the cash
     * @param array $cashAmounts Cash amounts indexed by year (1-6), missing years default to 0
