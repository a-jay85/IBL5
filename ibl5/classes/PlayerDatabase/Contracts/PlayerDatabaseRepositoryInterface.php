...
/**
 * PlayerDatabaseRepositoryInterface - Contract for database search operations
 * 
 ...
 * All methods accept validated parameters from PlayerDatabaseValidatorInterface.
 */
interface PlayerDatabaseRepositoryInterface
{
    /**
     ...
     * 
     * @param array<string, int|string|null> $params Validated parameters from PlayerDatabaseValidatorInterface
     * @return array{
