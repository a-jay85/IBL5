...
define("_ENTERINFO","Angi informasjon etter v�re spesifikasjoner");
define("_PRODUCTTITLE","Produktnavn");
define("_NAMEPRODUCT","Navnet p� produktet du anmelder.");
define("_REVIEW","Anmeldelse");
define("_CHECKREVIEW","Den egentlige anmeldelsen. Fors�k � gj�re den grammatisk korrekt! Skriv minst 100 ord. Du m� gjerne bruke HTML-kode dersom du ved hvordan!");
...
define("_PRODUCTSITE","Produktets ofisielle websted. Merk: adressen m� begynne med \"http://\"");
define("_LINKTITLE","Titell p� linken");
define("_LINKTITLEREQ","Kreves om du har en relatert link.");
define("_RIMAGEFILE","Bildets filnavn");
define("_RIMAGEFILEREQ","Navnet p� billedfilen til produktet. Skal ligge i mappen /images/reviews/");
define("_CHECKINFO","V�r sikker p� at informasjonen du har angitt er riktig og du bruker riktig grammatikk og tegnsetting.");
define("_INVALIDTITLE","Feil i tittel... Feltet kan ikke v�re tomt");
define("_INVALIDSCORE","Feil i karakter... M� v�re mellom 1 og 10");
define("_INVALIDTEXT","Feil i anmeldelsestekst... Feltet kan ikke v�re tomt\");
define("_INVALIDHITS","Treff m� v�re en positiv integer");
define("_CHECKNAME","Du m� oppgi b�de ditt navn og din e-postadresse");
define("_INVALIDEMAIL","Ugyldig e-postadresse. M� v�re p� formen navn@adresse.no");
define("_INVALIDLINK","Du m� angi B�DE tittel p� link og relatert link, eller la begge felt v�re tomme.");
...
define("_ISAVAILABLE","Den er n� tilgjengelig i v�r database.");
define("_EDITORWILLLOOK","V�re redakt�rer vil se p� den. Den b�r v�re publisert i l�pet av kort tid!");
...
define("_PREMODS","Forh�ndsvis modifisering");
define("_PAGE","Side");
