...
/**
 * Tests for PlayerDatabaseService
 *
 * Tests business logic layer for player search functionality.
 */
#[AllowMockObjectsWithoutExpectations]
final class PlayerDatabaseServiceTest extends TestCase
{
    private PlayerDatabaseService $service;
    private PlayerDatabaseValidator $validator;
    /** @var PlayerDatabaseRepository&\PHPUnit\Framework\MockObject\MockObject */
    ...
    {
        $this->validator = new PlayerDatabaseValidator();
        $this->mockSearchRepository = $this->createMock(PlayerDatabaseRepository::class);
        $this->mockPlayerRepository = $this->createMock(PlayerRepository::class);
        $this->service = new PlayerDatabaseService(
            $this->validator,
