...
/**
 * PlayerDatabaseServiceInterface - Contract for the player search business logic
 * 
 ...
 */
interface PlayerDatabaseServiceInterface
{
    /**
     * Execute a player search based on form parameters
     * 
     * Orchestrates the complete search workflow:
     * 1. Validates all parameters using PlayerDatabaseValidatorInterface
     * 2. Executes search using PlayerDatabaseRepositoryInterface
