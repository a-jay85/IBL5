...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> player-movement-empty-mobile
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=PlayerMovement", waiting until "load"
