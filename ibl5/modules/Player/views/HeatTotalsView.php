...
class HeatTotalsView extends BaseView {
    public function render() {
        echo "<table border=1 cellspacing=0 class=\"sortable\" style='margin: 0 auto;'>
            <tr>
                <td colspan=15 style='font-weight:bold;text-align:center;background-color:#00c;color:#fff;'>H.E.A.T. Totals</td>
            </tr>
            <tr>
                <th>year</th>
                <th>team</th>
        ...
        $resultplayoff4 = $this->db->sql_query("SELECT * FROM ibl_heat_stats WHERE name='" . $this->player->name . "' ORDER BY year ASC");
        ...
        echo "<tr>
            <td colspan=2 style='font-weight:bold;'>H.E.A.T. Totals</td>
