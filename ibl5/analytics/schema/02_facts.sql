...
WITH hist_raw AS (
    SELECT
        ...
        -- r_do alias preserved (downstream queries still reference it).
        TRY_CAST(r_drive_off AS INTEGER) AS r_do,
        TRY_CAST(r_po AS INTEGER)  AS r_po,
        TRY_CAST(r_trans_off AS INTEGER) AS r_trans_off,
...
SELECT
    ...
    TRY_CAST(game_min AS INTEGER) AS minutes,
    TRY_CAST(game_2gm AS INTEGER) AS fg2_made,
    TRY_CAST(game_2ga AS INTEGER) AS fg2_att,
    TRY_CAST(game_ftm AS INTEGER) AS ft_made,
    TRY_CAST(game_fta AS INTEGER) AS ft_att,
    TRY_CAST(game_3gm AS INTEGER) AS fg3_made,
    TRY_CAST(game_3ga AS INTEGER) AS fg3_att,
    TRY_CAST(game_orb AS INTEGER) AS orb,
    TRY_CAST(game_drb AS INTEGER) AS drb,
    TRY_CAST(game_ast AS INTEGER) AS ast,
    TRY_CAST(game_stl AS INTEGER) AS stl,
    TRY_CAST(game_tov AS INTEGER) AS tov,
    TRY_CAST(game_blk AS INTEGER) AS blk,
    TRY_CAST(game_pf AS INTEGER)  AS pf,
...
SELECT
    ...
    -- Quarter scores
    TRY_CAST(visitor_q1_points AS INTEGER) AS visitor_q1,
    TRY_CAST(visitor_q2_points AS INTEGER) AS visitor_q2,
    TRY_CAST(visitor_q3_points AS INTEGER) AS visitor_q3,
    TRY_CAST(visitor_q4_points AS INTEGER) AS visitor_q4,
    TRY_CAST(visitor_ot_points AS INTEGER) AS visitor_ot,
    TRY_CAST(home_q1_points AS INTEGER) AS home_q1,
    TRY_CAST(home_q2_points AS INTEGER) AS home_q2,
    TRY_CAST(home_q3_points AS INTEGER) AS home_q3,
    TRY_CAST(home_q4_points AS INTEGER) AS home_q4,
    TRY_CAST(home_ot_points AS INTEGER) AS home_ot,
    -- Totals
...
SELECT
    ...
    TRY_CAST(r_drive_off AS INTEGER) AS r_drive_off, TRY_CAST(dd AS INTEGER) AS dd,
    TRY_CAST(po AS INTEGER) AS po, TRY_CAST(pd AS INTEGER) AS pd,
    TRY_CAST(r_trans_off AS INTEGER) AS r_trans_off, TRY_CAST(td AS INTEGER) AS td,
    ...
    TRY_CAST(c_depth AS INTEGER) AS c_depth,
    -- Season stats
    ...
    TRY_CAST(playing_time AS INTEGER) AS playing_time, TRY_CAST(winner AS INTEGER) AS winner,
    ...
    -- Other fields
    TRY_CAST(dc_can_play_in_game AS INTEGER) AS dc_can_play_in_game,
