...
define("_FORUM", "Foorum");
define("_FORUMACC", "Kasutaja");
define("_FORUMCONF", "Seaded");
define("_FORUMRANK", "Tasemed");
define("_UNABLETOQUERY", "Connection to the Bankrupt Database");
define("_TODAYIS", "T�na on");
define("_LASTVISIT", "Sinu viimane foorumi k�lastus oli ");
define("_TYPES", "Preferences");
define("_FTOPICS", "Arutelu");
define("_FPOSTS", "S�numid");
define("_FLPOSTS", "Viimane s�num");
define("_PMSG", "Privaatsed s�numid");
define("_PINBOX", "Postkast");
define("_LOGINTOR", "Sa pead uudiste lugemiseks sisse logima.");
define("_VNMS", "Uued S�numid");
define("_VNM", "Uued S�numid");
define("_TVM", "K�ik S�numid");
define("_NPM", "Sul ei ole salvestunud s�numeid");
define("_NPO", "Sul on viimasest k�lastusest uued s�numid");
define("_NNPO", "Sinu viimasest k�lastusest pole uusi s�numeid");
define("_FFA", "Free to all");
define("_FREG", "Registreeritud kasutajad");
define("_FMODS", "Moderaator");
define("_PASSW", "Salas�naga kaitstud");
...
define("_FINDEX", "Pealeht");
define("_FPRIVATE", "See on privaatne foorum, pead sisse logima");
define("_FREPLIES", "Kordused");
define("_FPOSTER", "Postitaja");
define("_FVIEWS", "Vaated");
define("_FODATE", "Kuup�ev");
define("_FNOTOPICS", "Selles foorumis pole uusi teemasi");
define("_FPOSTONE", "Soovikorral v�id postitada uue teema.");
define("_FNEXTP", "J�rgmine leht");
define("_JUMPTO", "H�ppa");
define("_FSELECTF", "Vali Foorum");
define("_TLOCKED", "Arutelu l�petatud-Teema on suletud");
define("_MORETHEN", "More then");
define("_WRONGPASS", "Password not recognized!");
define("_FNOMORE", "There are no more Forums.");
define("_FFMOD", "Moderaator");
...
define("_FPOSTED", "Uus s�num on postitatud!");
...
define("_YOUNOT", "Sa ei tohi siia kirjutada!");
define("_FBACK", "Tagasi");
define("_FNICKNAME", "Nimi");
define("_FPASSWORD", "Salas�na");
define("_FSUBJECT", "Teema");
define("_FMESSAGE", "S�num");
define("_FMICON", "S�numi ikoon");
define("_FON", "sees");
define("_FOFF", "v�ljas");
define("_FOPTIONS", "Seaded");
define("_DISHTML", "HTML pole selles s�numis lubatud");
define("_FDIS", "Pole lubatud");
define("_FTHISMAIL", "selles s�numis");
define("_FSHOWSIG", "Company");
define("_WHATISSIG", "That one is setup in the User Pages.");
define("_FNOTIFY", "Notify me by email when there is a new post.(Only for registerd users)");
define("_FPAGED", "Lehed");
define("_FAQOUTE", "H��leta");
define("_FAUTHOR", "Autor");
define("_FGOTO", "Mine lehele: ");
define("_FADMINT", "Administreerimine");
define("_LOCKTHIS", "Sulge teema");
define("_UNLOCKTHIS", "Ava teema");
define("_FMOVET", "Liiguta teemat");
define("_FDELT", "T�hista teema");
define("_FJOINED", "Registered to :");
define("_FAPOSTS", "S�numid :");
define("_FFROM", "Da");
define("_NOTREG", "Kasutaja pole registreerinud");
define("_FTPOSTED", "Saadetud");
define("_FAPROFIL", "Profiil");
define("_FAEMAIL", "E-mail");
define("_FAADD", "Post");
define("_FAEDIT", "Redigeeri");
define("_TREVIEW", "Review your Reply");
define("_ENM", "Loe");
define("_FPAGES", "Lehed");
define("_BENV", "Tere tulemast foorumisse");
...
define("_ERRORE1", "Seal oli probleem");
...
define("_FRESET", "T�hista");
define("_FCANC", "Katkesta");
...
define("_CIAO", "Hello");
define("_NOTIFM1", "You have recieved this email because someone has posted a reply to your message you posted on $sitename, and you chose");
