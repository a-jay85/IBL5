...
#    Replace REPLACE_ME_* placeholders with your actual credentials from config.php:
#    - REPLACE_ME_USERNAME  → [your database username]
#    - REPLACE_ME_PASSWORD  → [your database password]
#    - REPLACE_ME_DATABASE  → [your database name]
...
| Credentials in markdown | Reference instead of expose | `grep -r "[your database username]" *.md` = 0 matches ✅ |
