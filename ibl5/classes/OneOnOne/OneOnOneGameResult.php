...
class OneOnOneGameResult
{
    ...
    public OneOnOnePlayerStats $player1Stats;
    public OneOnOnePlayerStats $player2Stats;
    ...
    {
        $this->player1Stats = new OneOnOnePlayerStats();
        $this->player2Stats = new OneOnOnePlayerStats();
    }
