...
define("_YOURADMINENCY", "� Administrador, esta enciclopedia non est� activa!");
define("_ENCYNOTACTIVE", "Desculpe, esta enciclopedia non est� activa neste momento.");
...
define("_NORESULTSTITLE", "Non hai Resultados no T�tulos dos Termos...");
define("_SEARCHRESULTSFOR", "Resultados da B�squeda de:");
define("_SEARCHNOTCOMPLETE", "As Opci�ns de B�squeda non est�n completas. Int�nteo de novo.");
define("_RESULTSINTERMTITLE", "Resultados nos t�tulos dos termos:");
