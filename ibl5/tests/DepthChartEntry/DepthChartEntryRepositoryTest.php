...
class DepthChartEntryRepositoryTest extends TestCase
{
    ...
    public function testDatabaseUpdateQueryMapsFieldsCorrectly(): void
    {
        ...
        $this->assertCount(7, $boundDatabaseColumns, 'Should have 7 bound database columns');
    ...
    public function testCompleteDataFlowFromFormToDatabase(): void
    {
        ...
        $this->assertCount(count($processedBoundKeys), $boundDatabaseColumns, 'Number of bound keys should match bound database columns');
        $this->assertCount(5, $hardcodedColumns, 'Should have 5 hardcoded columns');
