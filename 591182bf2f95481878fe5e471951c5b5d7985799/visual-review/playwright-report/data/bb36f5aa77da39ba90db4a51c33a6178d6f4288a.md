...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 1889px, received 375px by 2055px. 95541 pixels (ratio 0.13 of all image pixels) are different.
    ...
    - generic [ref=f1e28]:
      ...
      - generic [ref=f1e554]:
        ...
        - generic [ref=f1e593]:
          ...
          - list [ref=f1e599]:
            - listitem [ref=f1e600]: 2025-Present A-Jay
      - generic [ref=f1e602]:
        - heading "Franchise History" [level=2] [ref=f1e604]
        - generic [ref=f1e605]:
          - generic [ref=f1e606]:
            - heading "H.E.A.T." [level=3] [ref=f1e607]
            - list
            - generic [ref=f1e608]: "Totals: 0-0 (0.000)"
          - generic [ref=f1e609]:
            - heading "Regular Season" [level=3] [ref=f1e610]
            - list
            - generic [ref=f1e611]: "Totals: 0-0 (0.000)"
          - generic [ref=f1e612]:
            - heading "Playoffs" [level=3] [ref=f1e613]
            - generic [ref=f1e614]: "Post-Season: 0-0 (0.000) · Series: 0-0 (0.000)"
```
