...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1988px, received 1280px by 2129px. 100771 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - main [ref=f1e80]:
    ...
    - generic [ref=f1e90]:
      ...
      - generic [ref=f1e93]:
        ...
        - generic [ref=f1e103]:
          - strong [ref=f1e104]: Your key is part of this URL.
          ...
          - code [ref=f1e105]: X-API-Key
          - text: header instead. If the URL gets shared, revoke the key and generate a new one.
        - heading "Column Reference" [level=3] [ref=f1e106]
        - table [ref=f1e107]:
          - rowgroup [ref=f1e108]:
            - row [ref=f1e109]:
              - columnheader "Column" [ref=f1e110]
              - columnheader "Description" [ref=f1e111]
          - rowgroup [ref=f1e112]:
            - row [ref=f1e113]:
              - cell "PID" [ref=f1e114]
              - cell "Player ID" [ref=f1e115]
            - row [ref=f1e116]:
              - cell "Name" [ref=f1e117]
              - cell "Player name" [ref=f1e118]
            - row [ref=f1e119]:
              - cell "Nickname" [ref=f1e120]
              - cell "Player nickname" [ref=f1e121]
            - row [ref=f1e122]:
              - cell "Age" [ref=f1e123]
              - cell "Player age" [ref=f1e124]
            - row [ref=f1e125]:
              - cell "Position" [ref=f1e126]
              - cell "PG, SG, SF, PF, or C" [ref=f1e127]
            - row [ref=f1e128]:
              - cell "Height (ft) / Height (in)" [ref=f1e129]
              - cell "Height in feet and inches" [ref=f1e130]
            - row [ref=f1e131]:
              - cell "Active" [ref=f1e132]
              - cell "1 = on a depth chart, 0 = not" [ref=f1e133]
            - row [ref=f1e134]:
              - cell "Retired" [ref=f1e135]
              - cell "1 = retired, 0 = active" [ref=f1e136]
            - row [ref=f1e137]:
              - cell "Experience" [ref=f1e138]
              - cell "Years of experience" [ref=f1e139]
            - row [ref=f1e140]:
              - cell "Bird Rights" [ref=f1e141]
              - cell "Bird rights status" [ref=f1e142]
            - row [ref=f1e143]:
              - cell "Team ID / Team City / Team Name" [ref=f1e144]
              - cell "Team information (empty for free agents)" [ref=f1e145]
            - row [ref=f1e146]:
              - cell "Owner" [ref=f1e147]
              - cell "Team owner username" [ref=f1e148]
            - row [ref=f1e149]:
              - cell "Contract Year" [ref=f1e150]
              - cell "Current year of contract (1-6, 0 = unsigned)" [ref=f1e151]
            - row [ref=f1e152]:
              - cell "Current Salary" [ref=f1e153]
              - cell "Salary for the current contract year (thousands)" [ref=f1e154]
            - row [ref=f1e155]:
              - cell "Year 1-6 Salary" [ref=f1e156]
              - cell "Full contract breakdown by year (thousands)" [ref=f1e157]
            - row [ref=f1e158]:
              - cell "GP / MIN" [ref=f1e159]
              - cell "Games played / minutes played (season totals)" [ref=f1e160]
            - row [ref=f1e161]:
              - cell "FGM / FGA" [ref=f1e162]
              - cell "Field goals made / attempted (season totals)" [ref=f1e163]
            - row [ref=f1e164]:
              - cell "FTM / FTA" [ref=f1e165]
              - cell "Free throws made / attempted (season totals)" [ref=f1e166]
            - row [ref=f1e167]:
              - cell "3PM / 3PA" [ref=f1e168]
              - cell "Three-pointers made / attempted (season totals)" [ref=f1e169]
            - row [ref=f1e170]:
              - cell "ORB / DRB" [ref=f1e171]
              - cell "Offensive / defensive rebounds (season totals)" [ref=f1e172]
            - row [ref=f1e173]:
              - cell "AST / STL / TO / BLK / PF" [ref=f1e174]
              - cell "Assists, steals, turnovers, blocks, personal fouls (season totals)" [ref=f1e175]
            - row [ref=f1e176]:
              - cell "PPG" [ref=f1e177]
              - cell "Points per game" [ref=f1e178]
            - row [ref=f1e179]:
              - cell "FG% / FT% / 3P%" [ref=f1e180]
              - cell "Shooting percentages" [ref=f1e181]
        - heading "Tips" [level=3] [ref=f1e182]
        - list [ref=f1e183]:
          - listitem [ref=f1e184]: Data refreshes each time Google Sheets recalculates (approximately every hour).
          - listitem [ref=f1e185]: Use Google Sheets' built-in FILTER, SORT, and QUERY functions to slice the data.
          - listitem [ref=f1e186]: Salary values are in thousands (e.g., 1500 = $1,500K).
          - listitem [ref=f1e187]: Stats columns (GP, MIN, FGM, etc.) are season totals. Divide by GP for per-game averages.
        - heading "Key Management" [level=3] [ref=f1e188]
        - paragraph [ref=f1e189]: Visit API Key Management to view, revoke, or regenerate your key. Each user can have one active key at a time.
```
