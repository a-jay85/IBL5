...
if ($row2['radminsuper'] == 1 || $auth_user == 1) {
    ...
    function displayStory($qid)
    {
        ...
        if ($uname != $anonymous) {
            ...
            echo "&nbsp;&nbsp;<font class=\"content\">[ <a href=\"mailto:$email?Subject=Re: $subject\">" . _EMAIL . "</a> ]</font>";
        }
    ...
    function previewStory($automated, $year, $day, $month, $hour, $min, $qid, $uid, $author, $subject, $hometext, $bodytext, $topic, $notes, $catid, $ihome, $alanguage, $acomm, $pollTitle, $optionText, $assotop)
    {
        ...
        if ($author != $anonymous) {
            ...
            echo "&nbsp;&nbsp;<font class=\"content\">[ <a href=\"mailto:$email?Subject=Re: $subject\">" . _USER . "</a> ]</font>";
        }
    ...
    function submissions()
    {
        ...
        if ($db->sql_numrows($result) == 0) {
            ...
            while (list($qid, $uid, $uname, $subject, $timestamp, $alanguage) = $db->sql_fetchrow($result)) {
                ...
                if ($uname != $anonymous) {
                    echo "</td><td bgcolor=\"$bgcolor1\" align=\"center\" nowrap><font size=\"2\">&nbsp;$uname$karma</font>\n";
                } else {
