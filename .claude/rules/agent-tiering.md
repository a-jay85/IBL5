...
| **Fable** | `model: "fable"` | Rung above Opus (~2× cost). Default to Opus; **never spawn Fable without prompting the user first**; a def pinned to Fable is a standing yes. Full gate: `agent-tiering-fable-gate.md`. |
