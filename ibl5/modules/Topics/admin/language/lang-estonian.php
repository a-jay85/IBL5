...
define("_TOPICNAME1", "(lihtsalt nimi ilma t�hikuteta - max: 20 t�hem�rki)");
define("_TOPICNAME2", "(n�iteks: hobid&tegevused)");
define("_TOPICTEXT", "Teema tekst");
define("_TOPICTEXT1", "(t�ielik teema tekst v�i kirjeldus  - max: 40 t�hem�rki)");
define("_TOPICTEXT2", "(n�iteks: Tegevus ja huvialad)");
...
define("_TOPICDELSURE1", "See kustutab �htlasi K�IK jutud ja kommentarid!");
