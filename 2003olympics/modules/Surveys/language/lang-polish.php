...
define("_COMMENTSWARNING", "Komentarze s� w�asno�ci� ich tw�rc�w. Nie ponosimy odpowiedzialno�ci za ich tre��.");
define("_SCORE", "Wynik:");
...
define("_NOANONCOMMENTS", "Komentowanie niedozwolone dla anonimowego u�ytkownika, prosz� si� <a href=\"modules.php?name=Your_Account&amp;op=new_user&amp;op=new_user\">zarejestrowa�</a>");
define("_PARENT", "Nadrz�dny");
define("_ROOT", "G��wny");
...
define("_NOTRIGHT", "Co� jest nie tak ze zmienn� w tej funkcji. Ta wiadomo�� ma w�a�nie ustrzec Ci� od b��d�w");
define("_DIRECTCOM", "Bezpo�redni przegl�d komentarza...");
define("_SENDAMSG", "Wy�lij wiadomo��");
define("_PASTSURVEYS", "Poprzednie ankiety");
define("_LVOTES", "G�os�w");
define("_TOTALVOTES", "Razem g�os�w:");
...
define("_SURVEYSATTACHED", "Ankiety dodane do artyku��w");
define("_LAST5POLLS", "Najnowsze 5 ankiet na");
define("_MOREPOLLS", "...wi�cej ankiet");
