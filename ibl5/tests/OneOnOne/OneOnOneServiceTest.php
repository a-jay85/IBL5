...
final class OneOnOneServiceTest extends TestCase
{
    ...
    /** @var OneOnOneRepository&\PHPUnit\Framework\MockObject\MockObject */
    ...
    {
        $this->mockRepository = $this->createMock(OneOnOneRepository::class);
        $this->mockGameEngine = $this->createMock(OneOnOneGameEngine::class);
        $this->service = new OneOnOneService($this->mockRepository, $this->mockGameEngine);
    }
