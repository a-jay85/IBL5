...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> career-leaderboards-mobile
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  33212 pixels (ratio 0.11 of all image pixels) are different.

  Snapshot: career-leaderboards-mobile.png

Call log:
  - Expect "toHaveScreenshot(career-leaderboards-mobile.png)" with timeout 10000ms
...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e26]:
    ...
    - heading "Career Leaderboards" [level=1] [ref=f1e30]
    - generic [ref=f1e32]:
      - generic [ref=f1e33]:
        - generic [ref=f1e34]: "Type:"
        - combobox "Type:" [ref=f1e35]:
          - option "Regular Season Totals" [selected]
          ...
          - option "Rookie Game Totals"
          - option "Sophomore Game Totals"
          - option "All-Star Game Totals"
          - option "All-Star Game Averages"
      - generic [ref=f1e36]:
        - generic [ref=f1e37]: "Category:"
        - combobox "Category:" [ref=f1e38]:
          - option "Points" [selected]
          - option "Games"
          - option "Minutes"
          - option "Field Goals Made"
          - option "Field Goals Attempted"
          - option "FG Percentage (avgs only)"
          - option "Free Throws Made"
          - option "Free Throws Attempted"
          - option "FT Percentage (avgs only)"
          - option "Three-Pointers Made"
          - option "Three-Pointers Attempted"
          - option "3P Percentage (avgs only)"
          - option "Offensive Rebounds"
          - option "Defensive Rebounds"
          - option "Total Rebounds"
          - option "Assists"
          - option "Steals"
          - option "Turnovers"
          - option "Blocked Shots"
          - option "Personal Fouls"
      - generic [ref=f1e39]:
        - generic [ref=f1e40]: "Include Retirees:"
        - combobox "Include Retirees:" [ref=f1e41]:
          - option "Yes" [selected]
          - option "No"
      - generic [ref=f1e42]:
      ...
      - button "Display Career Leaderboards" [ref=f1e46] [cursor=pointer]
```
