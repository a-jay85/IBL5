...
use Player\Stats\Contracts\PlayerRatingsAndSalaryViewInterface;
...
<table class="ibl-data-table player-view-table sortable">
    ...
    <tr>
        ...
        foreach ($historicalStats as $row) {
            ...
            $r_Off = $row['r_oo'] + $row['r_drive_off'] + $row['r_po'] + $row['r_trans_off'];
            $r_Def = $row['r_od'] + $row['r_dd'] + $row['r_pd'] + $row['r_td'];
    ...
    <tr>
        ...
        <td><?= (int) $row['r_tvr'] ?></td>
        <td><?= (int) $row['r_oo'] ?></td>
        <td><?= (int) $row['r_drive_off'] ?></td>
        <td><?= (int) $row['r_po'] ?></td>
        <td><?= (int) $row['r_trans_off'] ?></td>
        <td><?= (int) $row['r_od'] ?></td>
        <td><?= (int) $row['r_dd'] ?></td>
        <td><?= (int) $row['r_pd'] ?></td>
        <td><?= (int) $row['r_td'] ?></td>
