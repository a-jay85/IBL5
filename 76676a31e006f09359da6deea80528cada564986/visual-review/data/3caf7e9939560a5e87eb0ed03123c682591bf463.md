...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> trading
...
Call log:
  - navigating to "http://php/ibl5/modules.php?name=Trading", waiting until "load"
