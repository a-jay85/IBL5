 ...
 *
 * @phpstan-type ContractPlayerRow array{pid: int, name: string, pos: string, teamname: string, teamid: int, cy: int, cyt: int, cy1: int, cy2: int, cy3: int, cy4: int, cy5: int, cy6: int, bird: string, team_city: string|null, color1: string|null, color2: string|null}
 *
...
class ContractListRepository extends \BaseMysqliRepository implements ContractListRepositoryInterface
{
    ...
    {
        $query = "SELECT p.pid, p.name, p.pos, t.team_name AS teamname, p.teamid, p.cy, p.cyt, p.cy1, p.cy2, p.cy3, p.cy4, p.cy5, p.cy6, p.bird,
        ...
        /** @var list<array{name: string, pos: string, teamname: string, cy: int, cyt: int, cy1: int, cy2: int, cy3: int, cy4: int, cy5: int, cy6: int, bird: string, pid: int, teamid: int, team_city: string|null, color1: string|null, color2: string|null}> */
