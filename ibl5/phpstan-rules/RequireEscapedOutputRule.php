...
final class RequireEscapedOutputRule implements Rule
{
    ...
    private const SAFE_STATIC_CALLS = [
        ...
        'Player\PlayerImageHelper::renderPlayerCell',
        'TeamCellHelper::renderTeamCellOrFreeAgent',
        'TeamCellHelper::renderTeamCell',
        'UI\TeamCellHelper::renderTeamCellOrFreeAgent',
        'UI\TeamCellHelper::renderTeamCell',
        'StatsFormatter::formatPercentage',
        'StatsFormatter::formatPercentageWithDecimals',
        'StatsFormatter::formatPerGameAverage',
        'StatsFormatter::formatWithDecimals',
        'StatsFormatter::formatTotal',
        'StatsFormatter::formatPer36Stat',
        'StatsFormatter::calculatePoints',
        'BasketballStats\StatsFormatter::formatPercentage',
        'BasketballStats\StatsFormatter::formatPercentageWithDecimals',
        'BasketballStats\StatsFormatter::formatPerGameAverage',
        'BasketballStats\StatsFormatter::formatWithDecimals',
        'BasketballStats\StatsFormatter::formatTotal',
        'BasketballStats\StatsFormatter::formatPer36Stat',
        'BasketballStats\StatsFormatter::calculatePoints',
        'CardBaseStyles::getCardCssProperties',
        'Player\Views\CardBaseStyles::getCardCssProperties',
