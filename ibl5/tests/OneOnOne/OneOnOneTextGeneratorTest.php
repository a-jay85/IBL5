...
use OneOnOne\OneOnOneTextGenerator;

/**
 * Tests for OneOnOneTextGenerator
 */
final class OneOnOneTextGeneratorTest extends TestCase
{
    private OneOnOneTextGenerator $generator;

    protected function setUp(): void
    {
        $this->generator = new OneOnOneTextGenerator();
    }
