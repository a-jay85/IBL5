...
define("_ACTIVEBANNERS", "N�v�rende aktive bannere");
define("_ACTIVEBANNERS2", "Aktive bannere");
define("_IMPRESSIONS", "Visinger");
define("_IMPLEFT", "Gjenst�ende visninger.");
...
define("_PURCHASEDIMPRESSIONS", "Kj�pte visninger");
...
define("_SURETODELBANNER", "Er du sikker p� at du vil slette dette banneret?");
define("_EDITBANNER", "Rediger banner");
define("_ADDIMPRESSIONS", "Legg til flere visninger");
define("_DELETECLIENT", "Slett kunde");
define("_SURETODELCLIENT", "Du er p� vei til � slette kunden og alle dens bannere!!!");
