...
- Positive: Armed PRs left BEHIND — including by doc-only master merges that the eager-rebase workflow skips — now auto-unstick within at most 15 minutes, with no human intervention.
