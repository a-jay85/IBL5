...
if (isset($_POST['email'])) {
    ...
    if (strlen($jsb) < 2) {
        $error_message .= 'The jsb information you entered does not appear to be valid.<br />';
    }
    if (strlen($non_jsb) < 2) {
        $error_message .= 'The non-jsb information you entered does not appear to be valid.<br />';
    }
    ...
    $email_message .= "JSB League Experience: " . clean_string($jsb) . "\n";
    $email_message .= "Non-JSB League Experience: " . clean_string($non_jsb) . "\n";
