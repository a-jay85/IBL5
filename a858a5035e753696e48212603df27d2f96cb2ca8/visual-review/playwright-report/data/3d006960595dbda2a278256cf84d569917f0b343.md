...
- Name: smoke/visual-regression.spec.ts >> Visual regression — authenticated pages (full-page) >> voting-eoy-draft-mobile
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: voting-eoy-draft-mobile.png

Call log:
  - Expect "toHaveScreenshot(voting-eoy-draft-mobile.png)" with timeout 10000ms
