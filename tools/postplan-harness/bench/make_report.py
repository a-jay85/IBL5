...
<tr><td>Phase 6.5 twelve ported arming conditions (numbered 1–12; the skill's condition (11), unresolved review-thread findings, stays skill-only — the harness's 11 is master's plan-slug-drift hold)</td><td>compiled</td><td><code>harness/armable.py</code> — pure, fail-closed; condition (9) keeps an <b>add-only</b> LLM verdict</td></tr>
...
Everything with a checkable answer became code. The riskiest translation — the twelve ported arming conditions (numbered 1–12; the skill's condition (11), unresolved review-thread findings, stays skill-only — the harness's 11 is master's plan-slug-drift hold) —
