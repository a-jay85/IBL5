...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> topics
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1030px, received 1280px by 1074px. 102959 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: topics.png

Call log:
  - Expect "toHaveScreenshot(topics.png)" with timeout 10000ms
...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e70]:
    - generic [ref=f1e71]:
      - heading "Current Active Topics" [level=1] [ref=f1e72]
      - paragraph [ref=f1e73]: Click to list all articles in this topic
      - generic [ref=f1e74]:
        - generic [ref=f1e76]:
          - textbox "Search articles..." [ref=f1e80]
          - button "Search" [ref=f1e81] [cursor=pointer]
        - generic [ref=f1e82]:
          - combobox "Topic" [ref=f1e83]:
            - option "All Topics" [selected]
            - option "Draft Coverage"
            - option "IBL News"
            - option "Trade News"
          - combobox "Category" [ref=f1e84]:
            - option "All Categories" [selected]
            - option "General"
          - combobox "Author" [ref=f1e85]:
            - option "All Authors" [selected]
          - combobox "Date range" [ref=f1e86]:
            ...
            - option "2 Months"
            - option "3 Months"
          - combobox "Preset" [ref=f1e87]:
            - option "No Preset" [selected]
            - option "Transactions"
        - generic [ref=f1e88]:
          - generic [ref=f1e89]: "Search on:"
          - generic [ref=f1e90] [cursor=pointer]:
            - radio "Stories" [checked] [ref=f1e91]
            - generic [ref=f1e92]: Stories
          - generic [ref=f1e93] [cursor=pointer]:
            - radio "Users" [ref=f1e94]
            - generic [ref=f1e95]: Users
      - generic [ref=f1e96]:
        - generic [ref=f1e97]:
          - generic [ref=f1e98]:
            - link "Draft Coverage" [ref=f1e99] [cursor=pointer]:
              - /url: modules.php?name=News&topic=3
            - generic [ref=f1e100]:
              - heading [level=2] [ref=f1e101]:
                - link "Draft Coverage" [ref=f1e102] [cursor=pointer]:
                  - /url: modules.php?name=News&topic=3
              - generic [ref=f1e103]:
                - generic [ref=f1e104]:
                  - strong [ref=f1e105]: "0"
                ...
                - generic [ref=f1e107]:
                  - strong [ref=f1e108]: "0"
                  - text: Total Reads
          - paragraph [ref=f1e110]: ...There aren't any news yet for this topic...
        - generic [ref=f1e111]:
          - generic [ref=f1e112]:
            - link "IBL News" [ref=f1e113] [cursor=pointer]:
              - /url: modules.php?name=News&topic=1
            - generic [ref=f1e114]:
              - heading [level=2] [ref=f1e115]:
                - link "IBL News" [ref=f1e116] [cursor=pointer]:
                  - /url: modules.php?name=News&topic=1
              - generic [ref=f1e117]:
                - generic [ref=f1e118]:
                  - strong [ref=f1e119]: "28"
                  - text: Total News
                - generic [ref=f1e121]:
                  - strong [ref=f1e122]: "50"
                  - text: Total Reads
          - generic [ref=f1e123]:
            - list [ref=f1e124]:
              - listitem [ref=f1e125]:
                - link "All-Star Game recap" [ref=f1e126] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=29
              - listitem [ref=f1e127]:
                - link "Trade deadline approaches" [ref=f1e128] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=28
              - listitem [ref=f1e129]:
                - link "Welcome to the new IBL season" [ref=f1e130] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=27
              - listitem [ref=f1e131]:
                - link "General ·" [ref=f1e132] [cursor=pointer]:
                  - /url: modules.php?name=News&file=categories&op=newindex&catid=15
                - 'link "League roundup: category feature" [ref=f1e133] [cursor=pointer]':
                  - /url: modules.php?name=News&file=article&sid=26
              - listitem [ref=f1e134]:
                - link "Stars acquire top free agent" [ref=f1e135] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=24
              - listitem [ref=f1e136]:
                - link "Metros win season opener" [ref=f1e137] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=23
              - listitem [ref=f1e138]:
                - link "The Mavericks extend the all-star guard" [ref=f1e139] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=22
              - listitem [ref=f1e140]:
                - link "The Pilots trade the young prospect" [ref=f1e141] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=21
              - listitem [ref=f1e142]:
                - link "The Nuggets sign the veteran shooter" [ref=f1e143] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=20
              - listitem [ref=f1e144]:
                - link "The Bucks waive the reserve center" [ref=f1e145] [cursor=pointer]:
                  - /url: modules.php?name=News&file=article&sid=19
            - link "More →" [ref=f1e147] [cursor=pointer]:
              - /url: modules.php?name=News&new_topic=1
        - generic [ref=f1e148]:
          - generic [ref=f1e149]:
            - link "Trade News" [ref=f1e150] [cursor=pointer]:
              - /url: modules.php?name=News&topic=2
            - generic [ref=f1e151]:
              - heading [level=2] [ref=f1e152]:
                - link "Trade News" [ref=f1e153] [cursor=pointer]:
                  - /url: modules.php?name=News&topic=2
              - generic [ref=f1e154]:
                - generic [ref=f1e155]:
                  - strong [ref=f1e156]: "1"
          ...
          - list [ref=f1e161]:
            - listitem [ref=f1e162]:
              - link "Blockbuster trade shakes up the league" [ref=f1e163] [cursor=pointer]:
