...
function negotiate($pid)
{
    ...
    if ($rosterspots < 1 and $offer1 == 0) {
		...
		<form name=\"FAOffer\" method=\"post\" action=\"modules/Free_Agency/freeagentoffer.php\">
    ...
    echo "<form name=\"FAOfferDelete\" method=\"post\" action=\"modules/Free_Agency/freeagentofferdelete.php\">
