...
- Name: smoke/visual-regression.spec.ts >> Visual regression — public pages (full-page) >> season-archive-mobile
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  14148 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: season-archive-mobile.png

Call log:
  - Expect "toHaveScreenshot(season-archive-mobile.png)" with timeout 10000ms
...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e26]:
    - heading "IBL Season Archive" [level=1] [ref=f1e27]
    - table [ref=f1e28]:
      - rowgroup [ref=f1e29]:
        - row [ref=f1e30]:
          - columnheader "Season" [ref=f1e31] [cursor=pointer]
          - columnheader "HEAT Champion" [ref=f1e32] [cursor=pointer]
          - columnheader "IBL Champion" [ref=f1e33] [cursor=pointer]
          - columnheader "MVP" [ref=f1e34] [cursor=pointer]
      - rowgroup [ref=f1e35]:
        - row [ref=f1e36]:
          - cell [ref=f1e37]:
            - link "Season XXXVIII (2025-26)" [ref=f1e38] [cursor=pointer]:
              - /url: modules.php?name=SeasonArchive&year=2026
          - cell [ref=f1e39]:
            - link "Metros" [ref=f1e40] [cursor=pointer]:
              - /url: modules.php?name=Team&op=team&teamid=1&yr=2026
          - cell [ref=f1e41]
          - cell [ref=f1e42]
        - row [ref=f1e43]:
          - cell [ref=f1e44]:
            - link "Season XXXVII (2024-25)" [ref=f1e45] [cursor=pointer]:
              - /url: modules.php?name=SeasonArchive&year=2025
          - cell [ref=f1e46]
          - cell [ref=f1e47]
          - cell [ref=f1e48]
        - row [ref=f1e49]:
          - cell [ref=f1e50]:
            - link "Season XXXVI (2023-24)" [ref=f1e51] [cursor=pointer]:
              - /url: modules.php?name=SeasonArchive&year=2024
          - cell [ref=f1e52]
          - cell [ref=f1e53]
          - cell [ref=f1e54]
```
